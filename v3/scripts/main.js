...
function processFullData(fullData) {   //                        console.log('\n step 3\n');
    ...
    fullData["k1t11"]=fullData['01LEC01CT011'];
    fullData["k1t12"]= fullData['01LEC01CT012'];
    fullData["k1t13"]= fullData['01LEC01CT013'];
    fullData["k1t6"] = fullData['01LEC02CT006'];
    fullData["k1t7"] = fullData['01LEC01CT007'];
    fullData["k1t5"] = fullData['01LEC02CT005'];
    fullData["k1t3"] = fullData['01LEC02CT003'];
    fullData["k1t4"] = fullData['01LEC02CT004'];
    fullData["k1t1"] = fullData['01LEC02CT001'];
    fullData["k1t2"] = fullData['01LEC02CT002'];
    fullData["k1t8"] = fullData['01LEC01CT008'];
    fullData["k1t9"] = fullData['01LEC01CT009'];
    fullData["k1t10"] = fullData['01LCM11CT001'];
//Температуры на БО1 kgu 1
	fullData["k1t181"]= fullData['01LEC01CT181'];
    
fullData["k1t191"] = fullData['01LEC01CT191'];

fullData["k1t201"]= fullData['01LEC02CT201'];
fullData["k1t211"] = fullData['01LEC02CT211'];

//Температуры на БО2 kgu 1
fullData["k1t182"] = fullData['01LEC11CT181'];
fullData["k1t192"] = fullData['01LEC11CT191'];
fullData["k1t202"] = fullData['01LEC12CT201'];
fullData["k1t212"] = fullData['01LEC12CT211'];
//Обороты
fullData["k1td1"] = fullData['01LMP01DS001'];

fullData["k1td2"] = fullData['01LMP02DS001'];
fullData["k1td3"] = fullData['01LMP03DS001'];

fullData["k1pg"] = fullData['01LMN01DS001'];

//Уровни
fullData["k1sbr"] = fullData['01LCM11CL001'];
fullData["k1vanna"] = fullData['01LCM31CL001'];
fullData["k1bo1"] = fullData['01LCM21CL001'];
fullData["k1bo2"] = insatData['01LCM22CL001'];
