...
(function () {
    ...
    function ta(a, c, b) {
        if (v && Na) {
            ...
            a.width = c * P;
            a.height = b * P;
            Ba !== ua && (a.style.width = c + "px", a.style.height = b + "px", d.scale(P, P))
    ...
    function $(a, c, b) {
        c.getAttribute("state") !==
            b && (c.setAttribute("state", b), c.setAttribute("type", "button"), c.style.position = "relative", c.style.margin = "0px 0px 0px 0px", c.style.padding = "3px 4px 0px 4px", c.style.cssFloat = "left", c.setAttribute("title", a._cultureInfo[b + "Text"]), c.innerHTML = "<img style='height:16px;' src='" + Va[b].image + "' alt='" + a._cultureInfo[b + "Text"] + "' />")
    }
    ...
    function z(a, c) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Sa(this.ctx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ia(d, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                new U(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {
                    axisX: [],
                    axisX2: [],
                    axisY: [],
                    axisY2: []
    ...
    function wa(a, c) {
        for (var b = [], d, f = 0; f < a.length; f++)
            if (0 == f) b.push(a[0]);
                ...
                d = Math.abs((a[k].x - a[g].x) / (0 === a[k].x - a[h].x ? 0.01 : a[k].x - a[h].x)) * (c - 1) / 2 + 1;
                var l =
                    (a[k].x - a[g].x) / d;
                d = (a[k].y - a[g].y) / d;
    ...
    function U(a, c) {
        U.base.constructor.call(this, "ToolTip", c, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    var J = {},
        ...
        ea = {
            ...
            DataSeries: {
                ...
                legendText: null,
                legendMarkerBorderColor: "transparent",
        ...
        Fa = function () {
            ...
            return function (h, l, n) {
                ...
                var s = h[n + "Date"](),
                    ...
                    ba = h[n + "Seconds"](),
                    X = h[n + "Milliseconds"](),
                    x = q ? 0 : h.getTimezoneOffset();
                return n = l.replace(a, function (a) {
                    switch (a) {
                        case "D":
                            return s;
                        case "DD":
                        ...
                        case "ff":
                            return O(String(X).slice(0, 2), 2);
                        case "fff":
                            return O(String(X).slice(0, 3), 3);
                        case "t":
                            return 12 > t ? "a" : "p";
                        case "tt":
                            return 12 > t ? "am" : "pm";
                        ...
                        case "TT":
                            return 12 > t ? "AM" : "PM";
                        case "K":
                            return q ? "UTC" : (String(h).match(g) || [""]).pop().replace(k, "");
                        case "z":
        ...
        fa = function (a, c, b) {
            ...
            for (var u = 0; h && u < h.length; u++)
                if (c = h[u], "." === c && 0 > l) l = u;
                    ...
                    if ("%" === c) k *= 100;
                        ...
                        k /=
                            Math.pow(1E3, c.length - 1);
                        l = u + c.length - 1;
                        continue
                    } else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || (q = !0);
                    0 > l ? (n.push(c), "#" === c || "0" === c ? p++ : "," === c && r++) : (m.push(c), "#" !== c && "0" !== c || e++)
                }
            q && (c = Math.floor(a), s = (0 === c ? "" : String(c)).length - p, k /= Math.pow(10, s));
            0 > l && (l = u);
            k = (a * k).toFixed(e);
            c = k.split(".");
            k = (c[0] + "").split("");
            a = (c[1] + "").split("");
            k && "0" === k[0] && k.shift();
            for (u = q = h = e = l = 0; 0 < n.length;)
                if (c = n.pop(), "#" === c || "0" === c)
                    if (l++, l === p) {
                        var w = k,
                            k = [];
                        if ("0" === c)
                            for (c = p - e - (w ? w.length : 0); 0 < c;) w.unshift("0"),
                                c--;
                        for (; 0 < w.length;) b = w.pop() + b, u++, 0 === u % q && (h === r && 0 < w.length) && (b = g + b);
                        d && (b = "-" + b)
                    } else 0 < k.length ? (b = k.pop() + b, e++, u++) : "0" === c && (b = "0" + b, e++, u++), 0 === u % q && (h === r && 0 < k.length) && (b = g + b);
            else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (h++, q = u, u = 0, 0 < k.length && (b = g + b)) : b = 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), b += c.replace(/[0]+/, function (a) {
                return O(s,
                    a.length)
            }));
            d = "";
            for (g = !1; 0 < m.length;) c = m.shift(), "#" === c || "0" === c ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), g = !0) : "0" === c && (d += "0", g = !0) : 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? d += c.slice(1, c.length - 1) : "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? d += c : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), d += c.replace(/[0]+/, function (a) {
                return O(s, a.length)
            }));
            return b + ((g ? f : "") + d)
        },
    ...
    (function () {
        ...
        J.str = {
            tv: [74, 73, 78, 82, 32, 32, 86, 101, 114, 115, 105,
111, 110],
...
114, 101, 100, 105, 116, 72, 114, 101, 102])];
        ...
        J.fAWm = function (a) {
            if ("undefined" === typeof J.pro.sCH && !Oa) {
                var c = a[J.fSDec(J.str.ct)];
                c[J.fSDec(J.str.tBl)] = J.fSDec(J.str.tp);
                c[J.fSDec(J.str.fnt)] = 11 + J.fSDec(J.str.fntStr);
                c[J.fSDec(J.str.fSy)] = J.fSDec(J.str.gr);
                c[J.fSDec(J.str.fTx)](J.fSDec(J.str.tv), 2, a.height - 11 - 2)
            }
        }
    })();
    ...
    z.prototype._updateOptions = function () {
        ...
        this.options.zoomEnabled ?
            (this._zoomButton || (aa(this._zoomButton = document.createElement("button")), $(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), K(this._zoomButton, "click", function () {
                a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, $(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, $(a, a._zoomButton, "pan"));
                a.render()
            })), this._resetButton || (aa(this._resetButton = document.createElement("button")), $(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), K(this._resetButton,
                "click",
                function () {
                    a.toolTip.hide();
        ...
        this._menuButton ? this.exportEnabled ? va(this._menuButton) : aa(this._menuButton) :
            this.exportEnabled && v && (this._menuButton = document.createElement("button"), $(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), K(this._menuButton, "click", function () {
    ...
    z.prototype._updateSize = function () {
        ...
        return this.canvas.width !== a * P || this.canvas.height !== c * P ? (ta(this.canvas, a, c), ta(this.overlaidCanvas, a, c), ta(this._eventManager.ghostCanvas, a, c), !0) : !1
    };
    ...
    z.prototype.render = function (a) {
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var c = this.plotInfo.plotTypes[a], g = 0; g < c.plotUnits.length; g++) {
                var k = c.plotUnits[g],
                    h = null;
                k.targetCanvas = null;
                this.animatedRender && (k.targetCanvas = ia(this.width, this.height), k.targetCanvasCtx = k.targetCanvas.getContext("2d"));
                "line" === k.type ? h = this.renderLine(k) : "stepLine" === k.type ? h = this.renderStepLine(k) : "spline" === k.type ? h = this.renderSpline(k) : "column" === k.type ? h = this.renderColumn(k) : "bar" === k.type ? h = this.renderBar(k) :
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = ia(this.width, this.height).getContext("2d"), d.push(this.renderIndexLabels(a)));
        var l = this;
        0 < d.length ? (l.disableToolTip = !0, l._animator.animate(200, l.animationDuration, function (a) {
            ...
            for (var b = 0; b < d.length; b++) h = d[b], 1 > a && "undefined" !== typeof h.startTimePercent ? a >= h.startTimePercent && h.animationCallback(h.easingFunction(a -
                h.startTimePercent, 0, 1, 1 - h.startTimePercent), h) : h.animationCallback(h.easingFunction(a, 0, 1, 1), h);
        ...
        this.zoomEnabled || (this.panEnabled ||
            !this._zoomButton || "none" === this._zoomButton.style.display) || aa(this._zoomButton, this._resetButton);
            ...
            if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= z._supportedChartTypes.indexOf(a.type)) {
                ...
                for (k = 0; k < b.plotUnits.length; k++)
                    if (b.plotUnits[k].axisYType === a.axisYType && b.plotUnits[k].axisXType === a.axisXType &&
                        b.plotUnits[k].axisYIndex === a.axisYIndex && b.plotUnits[k].axisXIndex === a.axisXIndex) {
                        g = !0;
                        f = b.plotUnits[k];
                        break
                    }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var h = this.data[a.dataSeriesIndexes[k]],
                        ...
                        m = !1,
                        p;
                    if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var e = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ?
                    ...
                    for (l = 0; l < h.dataPoints.length; l++) {
                        "undefined" === typeof h.dataPoints[l].x && (h.dataPoints[l].x = l + (a.axisX.logarithmic ?
                            1 : 0));
                        ...
                        if (0 < l) {
                            if (a.axisX.logarithmic) {
                                var q = d / h.dataPoints[l - 1].x;
                                1 > q && (q = 1 / q);
                                b.minDiff > q && 1 !== q && (b.minDiff = q)
                            } else q = d - h.dataPoints[l - 1].x, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q);
                            null !== f && null !== h.dataPoints[l - 1].y && (a.axisY.logarithmic ? (q = f / h.dataPoints[l - 1].y, 1 > q && (q = 1 / q), c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q =
                                f - h.dataPoints[l - 1].y, 0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q)))
                        }
                        if (d < e && !n) null !== f && (p = d);
                        else {
                            if (!n && (n = !0, 0 < l)) {
    ...
    z.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = [], h = [], l = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    m.dataPoints[p].x.getTime ? (g = !0, d = m.dataPoints[p].x.getTime()) : d = m.dataPoints[p].x;
                    x(m.dataPoints[p].y) ? f = 0 : (f = m.dataPoints[p].y, 0 === n && (l = Math.min(f, l)));
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    if (0 < p) {
                        if (a.axisX.logarithmic) {
                            var w = d / m.dataPoints[p - 1].x;
                            1 > w && (w = 1 / w);
                            b.minDiff > w && 1 !== w && (b.minDiff = w)
                        } else w = d - m.dataPoints[p - 1].x, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w);
                        null !== f && null !== m.dataPoints[p - 1].y && (a.axisY.logarithmic ? 0 < f && (w = f / m.dataPoints[p -
                            1].y, 1 > w && (w = 1 / w), c.minDiff > w && 1 !== w && (c.minDiff = w)) : (w = f - m.dataPoints[p - 1].y, 0 > w && (w *= -1), c.minDiff > w && 0 !== w && (c.minDiff = w)))
                    }
                    if (d < s && !e) null !== m.dataPoints[p].y && (q = d);
                    else {
                        if (!e && (e = !0, 0 < p)) {
                            p -= 2;
                            continue
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === m.dataPoints[p].y ? b.viewPortMin === d && q < d && (b.viewPortMin = q) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f),
                            0 <= f ? k[d] = k[d] ? k[d] + f : f : h[d] = h[d] ? h[d] + f : f)
                    }
                }
            ...
            for (p in h) h.hasOwnProperty(p) && !isNaN(p) && (a = h[p], a < c.min && (c.min = Math.min(a, l)), a > c.max && (c.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a,
                l)), a > c.viewPortMax && (c.viewPortMax = a)))
        }
    };
    z.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = !1, h = !1, l = [], n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]],
                    p = 0,
                    e = !1,
                    r = !1,
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if (d < s && !e) null !== f && (q = d);
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === f ? b.viewPortMin === d && q < d && (b.viewPortMin = q) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f), 0 <= f ? k = !0 : 0 > f && (h = !0), l[d] =
                            l[d] ? l[d] + Math.abs(f) : Math.abs(f))
                    }
                }
                this.plotInfo.axisXValueType = m.xValueType = g ? "dateTime" : "number"
            }
    ...
    z.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, k, h = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (n.dataPoints[m].x && n.dataPoints[m].x.getTime || "dateTime" === n.xValueType) h = !0;
                for (m = 0; m < n.dataPoints.length; m++) {
                    "undefined" === typeof n.dataPoints[m].x && (n.dataPoints[m].x = m + (a.axisX.logarithmic ? 1 : 0));
                    n.dataPoints[m].x.getTime ? (h = !0, d = n.dataPoints[m].x.getTime()) : d = n.dataPoints[m].x;
                    ...
                    g < c.min && (c.min = g);
                    k > c.max && (c.max = k);
                    0 < m && (a.axisX.logarithmic ? (q = d / n.dataPoints[m - 1].x, 1 > q && (q = 1 / q), b.minDiff > q && 1 !== q && (b.minDiff = q)) : (q = d - n.dataPoints[m - 1].x, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q)), f && (null !== f[0] && n.dataPoints[m - 1].y && null !== n.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (q = f[0] / n.dataPoints[m - 1].y[0], 1 > q && (q = 1 / q), c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q = f[0] - n.dataPoints[m - 1].y[0], 0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q))));
                    if (!(d < u) || p) {
                        if (!p && (p = !0, 0 < m)) {
                            m -=
                                2;
                        ...
                        null === f ? b.viewPortMin === d && r < d && (b.viewPortMin = r) : (g < c.viewPortMin && (c.viewPortMin = g), k > c.viewPortMax && (c.viewPortMax = k))
                    }
                }
                this.plotInfo.axisXValueType = n.xValueType = h ? "dateTime" : "number"
            }
    };
    z.prototype.getDataPointAtXY = function (a,
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (f = R("markerSize", d[b].dataPoint, d[b].dataSeries) || 8, d[b].distance <= f / 2) {
                    c = !0;
                    break
                }
        for (b = 0; b < d.length; b++) c && "line" !== d[b].dataSeries.type && "stepLine" !== d[b].dataSeries.type && "area" !==
            d[b].dataSeries.type && "stepArea" !== d[b].dataSeries.type || (a ? d[b].distance <= a.distance && (a = d[b]) : a = d[b]);
        return a
    };
        ...
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1;
                    ...
                    for (b = 0; b < c.length; b++) f = c[b], g = document.createEvent("MouseEvent"), g.initMouseEvent(f, !0, !0, window, 1, d.screenX, d.screenY, d.clientX, d.clientY, !1, !1, !1, !1, 0, null), d.target.dispatchEvent(g), a.preventManipulation &&
        ...
        if (("normal" === this.plotInfo.axisPlacement ||
            ...
            if (this.panEnabled || this.zoomEnabled) {
                ...
                k && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged",
                    "zoom"), k && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (va(this._zoomButton, this._resetButton), $(this, this._zoomButton, "pan"), $(this, this._resetButton, "reset")))
            }
        }
        this.isDrag = !1
    };
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))
                ...
                var d = f ? this.dragStartPoint.x : this.plotArea.x1,
                    ...
                    n = g ? c - this.dragStartPoint.y : this.plotArea.y2 -
                    this.plotArea.y1;
                ...
                this.overlaidCanvasCtx.fillRect(d, h, l, n);
    ...
    z.prototype.validateRegion = function (a, c, b, d, f) {
        f = f || !1;
        for (var g = 0 <= this.zoomType.indexOf("x"), k = 0 <= this.zoomType.indexOf("y"), h = !1, l = [], n = [], m = [], p = 0; p < this.axisX.length; p++) this.axisX[p] && g && n.push(this.axisX[p]);
        for (p = 0; p < this.axisX2.length; p++) this.axisX2[p] && g && n.push(this.axisX2[p]);
        for (p = 0; p < this.axisY.length; p++) this.axisY[p] && k && n.push(this.axisY[p]);
        for (p = 0; p < this.axisY2.length; p++) this.axisY2[p] &&
            k && n.push(this.axisY2[p]);
        for (g = 0; g < n.length; g++) {
            var k = n[g],
                p = k.convertPixelToValue({
                    x: a,
                    y: c
                }),
            ...
            if (isFinite(k.dataInfo.minDiff))
                if (!(k.logarithmic && e / p < Math.pow(k.dataInfo.minDiff, 3) || !k.logarithmic && Math.abs(e - p) < 3 * Math.abs(k.dataInfo.minDiff) || p < k.minimum || e > k.maximum)) l.push(k), m.push({
                    val1: p,
                    val2: e
                }), h = !0;
                else if (!f) {
    ...
    z.prototype.renderIndexLabels = function (a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, f = 0, g = 0, k = b = g = d = f = 0, h = 0, l = 0; l < this._indexLabels.length; l++) {
            var n = this._indexLabels[l],
                m = n.chartType.toLowerCase(),
                p, e, r = R("indexLabelFontColor", n.dataPoint, n.dataSeries),
                k = R("indexLabelFontSize", n.dataPoint, n.dataSeries),
                h = R("indexLabelFontFamily", n.dataPoint, n.dataSeries);
            p = R("indexLabelFontStyle",
                n.dataPoint, n.dataSeries);
            e = R("indexLabelFontWeight", n.dataPoint, n.dataSeries);
            var g = R("indexLabelBackgroundColor", n.dataPoint, n.dataSeries),
                d = R("indexLabelMaxWidth", n.dataPoint, n.dataSeries),
                f = R("indexLabelWrap", n.dataPoint, n.dataSeries),
                q = R("indexLabelLineDashType", n.dataPoint, n.dataSeries),
                s = R("indexLabelLineColor", n.dataPoint, n.dataSeries),
                ...
                b = 0 < u ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0,
                w = {
                    percent: null,
                    total: null
                },
            ...
            if (null !== t && "" !== t) {
                var w = R("indexLabelPlacement", n.dataPoint, n.dataSeries),
                    y = R("indexLabelOrientation", n.dataPoint, n.dataSeries),
                    v = n.direction,
                    ba =
                    n.dataSeries.axisX,
                    X = n.dataSeries.axisY,
                    z = !1,
                    r = new W(a, {
                        x: 0,
                        y: 0,
                        maxWidth: d ? d : 0.5 * this.width,
                        maxHeight: f ? 5 * k : 1.5 * k,
                ...
                if (0 <= m.indexOf("line") || 0 <= m.indexOf("area") || 0 <= m.indexOf("bubble") || 0 <= m.indexOf("scatter")) {
                    if (n.dataPoint.x < ba.viewportMinimum || n.dataPoint.x > ba.viewportMaximum ||
                        n.dataPoint.y < X.viewportMinimum || n.dataPoint.y > X.viewportMaximum) continue
                } else if (0 <= m.indexOf("column")) {
                    if (n.dataPoint.x < ba.viewportMinimum || n.dataPoint.x > ba.viewportMaximum || n.bounds.y1 > c.y2 || n.bounds.y2 < c.y1) continue
                } else if (0 <= m.indexOf("bar")) {
                    if (n.dataPoint.x < ba.viewportMinimum || n.dataPoint.x > ba.viewportMaximum || n.bounds.x1 > c.x2 || n.bounds.x2 < c.x1) continue
                } else if (n.dataPoint.x < ba.viewportMinimum || n.dataPoint.x > ba.viewportMaximum) continue;
                d = g = 2;
                "horizontal" === y ? (k = r.width, h = r.height) : (h = r.width,
                    k = r.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= m.indexOf("line") || 0 <= m.indexOf("area")) w = "auto", g = 4;
                    else if (0 <= m.indexOf("stacked")) "auto" === w && (w = "inside");
                    else if ("bubble" === m || "scatter" === m) w = "inside";
                    p = n.point.x - k / 2;
                    "inside" !== w ? (d = c.y1, f = c.y2, 0 < v ? (e = n.point.y - h - g - b, e < d && (e = "auto" === w ? Math.max(n.point.y, d) + g + b : d + g + b, z = e + h > n.point.y)) : (e = n.point.y + g + b, e > f - h - g - b && (e = "auto" === w ? Math.min(n.point.y, f) - h - g - b : f - h - g - b, z = e < n.point.y))) : (d = Math.max(n.bounds.y1, c.y1), f = Math.min(n.bounds.y2,
                        c.y2), b = 0 <= m.indexOf("range") ? 0 < v ? Math.max(n.bounds.y1, c.y1) + h / 2 + g : Math.min(n.bounds.y2, c.y2) - h / 2 - g : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2, 0 < v ? (e = Math.max(n.point.y, b) - h / 2, e < d && ("bubble" === m || "scatter" === m) && (e = Math.max(n.point.y - h - g, c.y1 + g))) : (e = Math.min(n.point.y, b) - h / 2, e > f - h - g && ("bubble" === m || "scatter" === m) && (e = Math.min(n.point.y + g, c.y2 - h - g))), e = Math.min(e, f - h))
                } else 0 <= m.indexOf("line") || 0 <= m.indexOf("area") || 0 <= m.indexOf("scatter") ? (w = "auto", d = 4) : 0 <= m.indexOf("stacked") ? "auto" ===
                    w && (w = "inside") : "bubble" === m && (w = "inside"), e = n.point.y - h / 2, "inside" !== w ? (g = c.x1, f = c.x2, 0 > v ? (p = n.point.x - k - d - b, p < g && (p = "auto" === w ? Math.max(n.point.x, g) + d + b : g + d + b, z = p + k > n.point.x)) : (p = n.point.x + d + b, p > f - k - d - b && (p = "auto" === w ? Math.min(n.point.x, f) - k - d - b : f - k - d - b, z = p < n.point.x))) : (g = Math.max(n.bounds.x1, c.x1), Math.min(n.bounds.x2, c.x2), b = 0 <= m.indexOf("range") ? 0 > v ? Math.max(n.bounds.x1, c.x1) + k / 2 + d : Math.min(n.bounds.x2, c.x2) - k / 2 - d : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2, p = 0 > v ? Math.max(n.point.x,
                        b) - k / 2 : Math.min(n.point.x, b) - k / 2, p = Math.max(p, g));
                "vertical" === y && (e += h);
                r.x = p;
                r.y = e;
                r.render(!0);
                u && ("inside" !== w && (0 > m.indexOf("bar") && n.point.x > c.x1 && n.point.x < c.x2 || !z) && (0 > m.indexOf("column") && n.point.y > c.y1 && n.point.y < c.y2 || !z)) && (a.lineWidth = u, a.strokeStyle = s ? s : "gray", a.setLineDash && a.setLineDash(F(q, u)), a.beginPath(), a.moveTo(n.point.x, n.point.y), 0 <= m.indexOf("bar") ? a.lineTo(p + (0 < n.direction ? 0 : k), e + ("horizontal" === y ? h : -h) / 2) : 0 <= m.indexOf("column") ? a.lineTo(p + k / 2, e + ((0 < n.direction ? h : -h) + ("horizontal" ===
                    y ? h : -h)) / 2) : a.lineTo(p + k / 2, e + ((e < n.point.y ? h : -h) + ("horizontal" === y ? h : -h)) / 2), a.stroke())
            }
        }
        return {
            source: a,
    ...
    z.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.clip();
            for (var d = [], f = null, g = 0; g <
                a.dataSeriesIndexes.length; g++) {
                ...
                var e = h._colorSet,
                    r = e = h.lineColor = h.options.lineColor ? h.options.lineColor : e[0];
                c.strokeStyle = e;
                var q = !0,
                    s = 0,
                    u, w;
                ...
                if (0 < l.length) {
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].x.getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(h.connectNullData || y || q) && (c.stroke(), v && b.stroke()), y = !0;
                            else {
                                u = a.axisX.convertValueToPixel(u);
                                w = a.axisY.convertValueToPixel(l[s].y);
                                var t = h.dataPointIds[s];
                                ...
                                q || y ? (!q && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), n = h.nullDataLineDashType, c.setLineDash(m)), c.lineTo(u, w), v && b.lineTo(u, w)) : (c.beginPath(), c.moveTo(u, w), v && (b.beginPath(), b.moveTo(u, w))), y = q = !1) : (c.lineTo(u, w), v && b.lineTo(u, w), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(u, w), v && (b.stroke(), b.beginPath(), b.moveTo(u, w))));
                                s < l.length - 1 && (r !== (l[s].lineColor || e) || n !== (l[s].lineDashType ||
                                    h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(u, w), r = l[s].lineColor || e, c.strokeStyle = r, c.setLineDash && (l[s].lineDashType ? (n = l[s].lineDashType, c.setLineDash(F(n, h.lineThickness))) : (n = h.lineDashType, c.setLineDash(p))));
                                if (0 < l[s].markerSize || 0 < h.markerSize) {
                                    var G = h.getMarkerProperties(s, u, w, c),
                                        f = G.color;
                                    d.push(G);
                                    t = D(t);
                                    v && d.push({
                                ...
                                }(l[s].indexLabel || h.indexLabel || l[s].indexLabelFormatter || h.indexLabelFormatter) &&
    ...
    z.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length) {
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(h.connectNullData || y || q) && (c.stroke(), v && b.stroke()), y = !0;
                            else {
                                var t = w;
                                u = a.axisX.convertValueToPixel(u);
                                w = a.axisY.convertValueToPixel(l[s].y);
                                var G = h.dataPointIds[s];
                                ...
                                q || y ? (!q && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), n = h.nullDataLineDashType, c.setLineDash(m)), c.lineTo(u, t), c.lineTo(u, w), v && (b.lineTo(u, t), b.lineTo(u, w))) : (c.beginPath(), c.moveTo(u, w), v && (b.beginPath(), b.moveTo(u, w))), y = q = !1) : (c.lineTo(u, t), v && b.lineTo(u, t), c.lineTo(u,
                                    w), v && b.lineTo(u, w), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(u, w), v && (b.stroke(), b.beginPath(), b.moveTo(u, w))));
                                s < l.length - 1 && (r !== (l[s].lineColor || e) || n !== (l[s].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(u, w), r = l[s].lineColor || e, c.strokeStyle = r, c.setLineDash && (l[s].lineDashType ? (n = l[s].lineDashType, c.setLineDash(F(n, h.lineThickness))) : (n = h.lineDashType, c.setLineDash(p))));
                                if (0 < l[s].markerSize || 0 < h.markerSize) t = h.getMarkerProperties(s, u, w, c), f = t.color, d.push(t), G = D(G),
                                    v && d.push({
                                        x: u,
                                        y: w,
                                        ctx: b,
    ...
    z.prototype.renderSpline = function (a) {
        function c(a) {
            ...
            if (0 < a.length) {
                ...
                for (var c = 0; c < a.length - 3; c += 3)
                    if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), v && d.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                        0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), v && (d.stroke(), d.beginPath(), d.moveTo(a[c + 3].x, a[c + 3].y));
                b.stroke();
                v && d.stroke()
            }
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.rect(f.x1, f.y1, f.width,
                f.height);
            b.clip();
            for (var f = [], g = null, k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                var n = l.dataPoints,
                    m = "solid";
                if (b.setLineDash) {
                    var p = F(l.nullDataLineDashType, l.lineThickness),
                        m = l.lineDashType,
                        e = F(m, l.lineThickness);
                    b.setLineDash(e)
                }
                var r = l.id;
                ...
                var r = l._colorSet,
                    q = r = l.lineColor =
                    l.options.lineColor ? l.options.lineColor : r[0];
                b.strokeStyle = r;
                var s = 0,
                    u, w, y = [];
                b.beginPath();
                if (0 < n.length)
                    for (w = !1, s = 0; s < n.length; s++)
                        if (u = n[s].getTime ? n[s].x.getTime() : n[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !w)))
                            if ("number" !== typeof n[s].y) 0 < s && !w && (l.connectNullData ? b.setLineDash && (0 < y.length && (l.options.nullDataLineDashType || !n[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, m = l.nullDataLineDashType) : (c(y), y = [])), w = !0;
                            else {
                                u = a.axisX.convertValueToPixel(u);
                                ...
                                s < n.length - 1 && (q !== (n[s].lineColor || r) || m !== (n[s].lineDashType || l.lineDashType)) && (q = n[s].lineColor || r, y[y.length - 1].newStrokeStyle = q, b.setLineDash && (n[s].lineDashType ? (m = n[s].lineDashType, y[y.length - 1].newLineDashArray = F(m, l.lineThickness)) : (m = l.lineDashType, y[y.length - 1].newLineDashArray = e)));
                                if (0 < n[s].markerSize ||
                                    0 < l.markerSize) {
                                    var G = l.getMarkerProperties(s, u, w, b),
                                        g = G.color;
                                    f.push(G);
                                    t = D(t);
                                    v && f.push({
                                ...
                                }(n[s].indexLabel || l.indexLabel || n[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: n[s],
                                    dataSeries: l,
                                    point: {
    ...
    var M = function (a, c, b, d, f, g, k, h, l, n, m, p, e) {
        ...
        a.restore();
        !0 === l && (a.save(),
            a.beginPath(), a.moveTo(c, b), a.lineTo(c + r, b + r), a.lineTo(d - r, b + r), a.lineTo(d, b), a.closePath(), k = a.createLinearGradient((d + c) / 2, b + r, (d + c) / 2, b), k.addColorStop(0, g), k.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = k, a.fill(), a.restore());
        !0 === n && (a.save(), a.beginPath(), a.moveTo(c, f), a.lineTo(c + r, f - r), a.lineTo(d - r, f - r), a.lineTo(d, f), a.closePath(), k = a.createLinearGradient((d + c) / 2, f - r, (d + c) / 2, f), k.addColorStop(0, g), k.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = k, a.fill(), a.restore());
        !0 ===
            m && (a.save(), a.beginPath(), a.moveTo(c, b), a.lineTo(c + r, b + r), a.lineTo(c + r, f - r), a.lineTo(c, f), a.closePath(), k = a.createLinearGradient(c + r, (f + b) / 2, c, (f + b) / 2), k.addColorStop(0, g), k.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = k, a.fill(), a.restore());
        !0 === p && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d - r, b + r), a.lineTo(d - r, f - r), a.lineTo(d, f), k = a.createLinearGradient(d - r, (f + b) / 2, d, (f + b) / 2), k.addColorStop(0, g), k.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = k, k.addColorStop(0, g), k.addColorStop(1,
    ...
    z.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                n = this.dataPointMaxWidth = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
                this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0,
                m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            ...
            !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                n < f) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, f));
            m < f && (m = f);
            m > n && (m = n);
            c.save();
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < e.length)
                    for (var r = 5 < m && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ?
                            h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            g = a.axisX.convertValueToPixel(h);
                            k = a.axisY.convertValueToPixel(e[f].y);
                            g = a.axisX.reversed ? g + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + d) * m << 0 : g - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + d) * m << 0;
                            ...
                            M(c, g, k, q, s, b,
                                0, null, r && 0 <= e[f].y, 0 > e[f].y && r, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
                            ...
                            b = D(b);
                            v && M(this._eventManager.ghostCtx, g, k, q, s, b, 0, null, !1, !1, !1, !1);
    ...
    z.prototype.renderStackedColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                k = [],
                h = 0,
                l, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
            ...
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth &&
                h > m && (h = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, m));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && m < h) && (m = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, h));
            p < h && (p = h);
            p > m && (p = m);
            c.save();
            v && this._eventManager.ghostCtx.save();
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    for (h = 0; h < q.length; h++)
                        if (b = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                u = d - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                w = u + p << 0,
                                y;
                            if (a.axisY.logarithmic) k[b] = q[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (l = a.axisY.convertValueToPixel(k[b]), y = f[b] ? f[b] : n, f[b] = l);
                            else if (l =
                                a.axisY.convertValueToPixel(q[h].y), 0 <= q[h].y) {
                                var t = f[b] ? f[b] : 0;
                                l -= t;
                                y = n - t;
                                f[b] = t + (y - l)
                            } else t = g[b] ? g[b] : 0, y = l + t, l = n + t, g[b] = t + (y - l);
                            b = q[h].color ? q[h].color : r._colorSet[h % r._colorSet.length];
                            M(c, u, l, w, y, b, 0, null, s && 0 <= q[h].y, 0 > q[h].y && s, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = D(b);
                            v && M(this._eventManager.ghostCtx, u, l, w, y, b, 0, null, !1, !1, !1, !1);
                            (q[h].indexLabel || r.indexLabel || q[h].indexLabelFormatter ||
    ...
    z.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                k = [],
                h = 0,
                l, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                h = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
                m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0,
                p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth :
                0.9 * (d.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && h > m && (h = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, m));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && m < h) && (m = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, h));
            p < h && (p = h);
            p > m && (p = m);
            c.save();
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m],
                    ...
                    q = r.dataPoints;
                if (0 < q.length)
                    for (var s = 5 < p && r.bevelEnabled ? !0 : !1, h = 0; h < q.length; h++)
                        if (b = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[h].y) {
                            d = a.axisX.convertValueToPixel(b);
                            l = 0 !== a.dataPointYSums[b] ? 100 * (q[h].y / a.dataPointYSums[b]) : 0;
                            var u =
                                d - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                w = u + p << 0,
                                y;
                            if (a.axisY.logarithmic) {
                                ...
                                y = f[b] ? f[b] : n;
                                f[b] = l
                            } else if (l = a.axisY.convertValueToPixel(l), 0 <= q[h].y) {
                                var t = f[b] ? f[b] : 0;
                                l -= t;
                                y = n - t;
                                f[b] = t + (y - l)
    ...
    z.prototype.renderBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            m = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && f > n && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth &&
                (this.dataPointMinWidth && n < f) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, f));
            m < f && (m = f);
            m > n && (m = n);
            c.save();
            v && this._eventManager.ghostCtx.save();
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            k = a.axisX.reversed ? k + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + d) * m << 0 : k - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + d) * m << 0;
                            var q = a.axisX.reversed ? k - m << 0 : k + m << 0,
                                s;
                            0 <= e[f].y ? s = l : (s = g, g = l);
                            b = e[f].color ? e[f].color :
                                p._colorSet[f % p._colorSet.length];
                            M(c, s, k, g, q, b, 0, null, r, !1, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = D(b);
                            v && M(this._eventManager.ghostCtx, s, k, g, q, b, 0, null, !1, !1, !1, !1);
                            (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "bar",
                                dataPoint: e[f],
                                dataSeries: p,
                    ...
                    for (h = 0; h < q.length; h++)
                        if (b = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                ...
                                w = u + p << 0,
                                y;
                            if (a.axisY.logarithmic) k[b] = q[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (y = f[b] ? f[b] : n, f[b] = l = a.axisY.convertValueToPixel(k[b]));
                            else if (l =
                                a.axisY.convertValueToPixel(q[h].y), 0 <= q[h].y) {
                                var t = f[b] ? f[b] : 0;
                                y = n + t;
                                l += t;
                                f[b] = t + (l - y)
                            } else t = g[b] ? g[b] : 0, y = l - t, l = n - t, g[b] = t + (l - y);
                            b = q[h].color ? q[h].color : r._colorSet[h % r._colorSet.length];
                            M(c, y, u, l, w, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = D(b);
                            v && M(this._eventManager.ghostCtx, y, u, l, w, b, 0, null, !1, !1, !1, !1);
                            (q[h].indexLabel || r.indexLabel || q[h].indexLabelFormatter ||
                                r.indexLabelFormatter) && this._indexLabels.push({
                ...
                if (0 < q.length) {
                    ...
                    for (h = 0; h < q.length; h++)
                        if (b = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                u;
                            u = 0 !== a.dataPointYSums[b] ? 100 * (q[h].y /
                            ...
                            } else if (l = a.axisY.convertValueToPixel(u), 0 <= q[h].y) {
                                var t = f[b] ? f[b] : 0;
                                u = n + t;
                                l += t;
                                f[b] = t + (l - u)
                            } else t = g[b] ? g[b] : 0, u = l - t, l = n - t, g[b] = t + (l - u);
                            b = q[h].color ? q[h].color : r._colorSet[h % r._colorSet.length];
                            M(c, u, w, l, y, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = D(b);
                            v && M(this._eventManager.ghostCtx, u, w, l, y, b, 0, null, !1, !1, !1, !1);
                            (q[h].indexLabel || r.indexLabel || q[h].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
    ...
    z.prototype.renderArea = function (a) {
        function c() {
            t && (0 < m.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(), b.globalAlpha = m.fillOpacity, b.fill(), b.globalAlpha = 1, v && (d.lineTo(q, y), d.lineTo(t.x,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                var k = [],
                    ...
                    y, t = null;
                if (0 < p.length) {
                    var G = m._colorSet[r % m._colorSet.length],
                        x = m.lineColor = m.options.lineColor || G,
                        X = x;
                    b.fillStyle = G;
                    b.strokeStyle = x;
                    ...
                    for (var I = !0; r < p.length; r++)
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !I)))
                            if ("number" !== typeof p[r].y) m.connectNullData || (I || e) || c(), I = !0;
                            else {
                                q = a.axisX.convertValueToPixel(u);
                                s = a.axisY.convertValueToPixel(p[r].y);
                                e || I ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), z = m.nullDataLineDashType,
                                    b.setLineDash(A)), b.lineTo(q, s), v && d.lineTo(q, s)) : (b.beginPath(), b.moveTo(q, s), v && (d.beginPath(), d.moveTo(q, s)), t = {
                                    x: q,
                                    y: s
                                }), I = e = !1) : (b.lineTo(q, s), v && d.lineTo(q, s), 0 == r % 250 && c());
                                r < p.length - 1 && (X !== (p[r].lineColor || x) || z !== (p[r].lineDashType || m.lineDashType)) && (c(), X = p[r].lineColor || x, b.strokeStyle = X, b.setLineDash && (p[r].lineDashType ? (z = p[r].lineDashType, b.setLineDash(F(z, m.lineThickness))) : (z = m.lineDashType, b.setLineDash(Q))));
                                var H = m.dataPointIds[r];
                                ...
                                0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < m.markerSize) && (u = m.getMarkerProperties(r, q, s, b), h = u.color, k.push(u), H = D(H), v && k.push({
                                    x: q,
                                    y: s,
                                    ctx: d,
                                    type: u.type,
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < p.length) {
                    var t = m._colorSet[e % m._colorSet.length],
                        G = m.lineColor = m.options.lineColor || t,
                        x = G;
                    b.fillStyle = t;
                    b.strokeStyle = G;
                    b.lineWidth = m.lineThickness;
                    ...
                    if (b.setLineDash) {
                        var A = F(m.nullDataLineDashType, m.lineThickness),
                            z = m.lineDashType,
                            S = F(z, m.lineThickness);
                        b.setLineDash(S)
                    }
                    for (q = !1; e < p.length; e++)
                        if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax &&
                                (!m.connectNullData || !q)))
                            if ("number" !== typeof p[e].y) 0 < e && !q && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, z = m.nullDataLineDashType) : (c(), y = [])), q = !0;
                            else {
                                r = a.axisX.convertValueToPixel(r);
                                q = a.axisY.convertValueToPixel(p[e].y);
                                var Q = m.dataPointIds[e];
                                ...
                                e < p.length - 1 && (x !== (p[e].lineColor ||
                                    G) || z !== (p[e].lineDashType || m.lineDashType)) && (x = p[e].lineColor || G, y[y.length - 1].newStrokeStyle = x, b.setLineDash && (p[e].lineDashType ? (z = p[e].lineDashType, y[y.length - 1].newLineDashArray = F(z, m.lineThickness)) : (z = m.lineDashType, y[y.length - 1].newLineDashArray = S)));
                                if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize)) {
                                    ...
                                    m.indexLabel || p[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < p.length) {
                    ...
                    var S = "solid";
                    if (b.setLineDash) {
                        var Q = F(m.nullDataLineDashType, m.lineThickness),
                            S = m.lineDashType,
                            I = F(S, m.lineThickness);
                        b.setLineDash(I)
                    }
                    for (; r < p.length; r++)
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !G))) {
                            var H = s;
                            "number" !== typeof p[r].y ? (m.connectNullData ||
                                (G || e) || c(), G = !0) : (q = a.axisX.convertValueToPixel(u), s = a.axisY.convertValueToPixel(p[r].y), e || G ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || S === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), S = m.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(q, H), b.lineTo(q, s), v && (d.lineTo(q, H), d.lineTo(q, s))) : (b.beginPath(), b.moveTo(q, s), v && (d.beginPath(), d.moveTo(q, s)), t = {
                                x: q,
                                y: s
                            }), G = e = !1) : (b.lineTo(q, H), v && d.lineTo(q, H), b.lineTo(q, s), v && d.lineTo(q, s), 0 == r % 250 &&
                                c()), r < p.length - 1 && (A !== (p[r].lineColor || z) || S !== (p[r].lineDashType || m.lineDashType)) && (c(), A = p[r].lineColor || z, b.strokeStyle = A, b.setLineDash && (p[r].lineDashType ? (S = p[r].lineDashType, b.setLineDash(F(S, m.lineThickness))) : (S = m.lineDashType, b.setLineDash(I)))), H = m.dataPointIds[r], this._eventManager.objectMap[H] = {
                                id: H,
                                objectType: "dataPoint",
                                dataSeriesIndex: n,
                                dataPointIndex: r,
                                x1: q,
                                y1: s
                            }, 0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < m.markerSize) && (u = m.getMarkerProperties(r, q, s, b), h = u.color, k.push(u), H = D(H),
                                v && k.push({
                                    x: q,
                                    y: s,
                                    ctx: d,
    ...
    z.prototype.renderStackedArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            v && (u.beginPath(), u.rect(k.x1, k.y1, k.width, k.height), u.clip());
            for (var w = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                var y = a.dataSeriesIndexes[k],
                    t = this.data[y],
                    x = t.dataPoints;
                t.dataPointIndexes = [];
                for (p = 0; p < x.length; p++) y = x[p].x.getTime ? x[p].x.getTime() : x[p].x, t.dataPointIndexes[y] = p, w[y] || (n.push(y), w[y] = !0);
                n.sort(Aa)
            }
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < n.length) {
                    ...
                    var A = "solid";
                    if (b.setLineDash) {
                        var S = F(t.nullDataLineDashType, t.lineThickness),
                            A = t.lineDashType,
                            Q = F(A, t.lineThickness);
                        b.setLineDash(Q)
                    }
                    for (var I = !0, p = 0; p < n.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !I)))
                            if ("number" !== typeof H.y) t.connectNullData || (I || w) || c(), I = !0;
                            else {
                                ...
                                } else r = a.axisY.convertValueToPixel(H.y), r -= ga;
                                l.push({
                                    x: e,
                                    y: s - ga
                                });
                                h[q] = s - r;
                                w || I ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType ||
                                    A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(S)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(), u.moveTo(e, r))), I = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (c(), b.moveTo(e, r), v && u.moveTo(e, r), l.push({
                                    x: e,
                                    y: s - ga
                                })));
                                p < x.length - 1 && (X !== (x[p].lineColor || z) || A !== (x[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(e, r), l.push({
                                        x: e,
                                        y: s - ga
                                    }), X = x[p].lineColor || z, b.strokeStyle = X, b.setLineDash &&
                                    (x[p].lineDashType ? (A = x[p].lineDashType, b.setLineDash(F(A, t.lineThickness))) : (A = t.lineDashType, b.setLineDash(Q))));
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, e, r, b), g = q.color, f.push(q), markerColor = D(ha), v && f.push({
                                    x: e,
                                    y: r,
                                    ctx: u,
                                    type: q.type,
                    ...
                    for (var I = !0, p = 0; p < n.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !I)))
                            if ("number" !== typeof H.y) t.connectNullData || (I || w) || c(), I = !0;
                                ...
                                p < x.length - 1 && (X !== (x[p].lineColor || z) || A !== (x[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(e, r),
                                    l.push({
                                        x: e,
                                        y: s - ha
                                    }), X = x[p].lineColor || z, b.strokeStyle = X, b.setLineDash && (x[p].lineDashType ? (A = x[p].lineDashType, b.setLineDash(F(A, t.lineThickness))) : (A = t.lineDashType, b.setLineDash(Q))));
                                if (0 <= t.dataPointIndexes[q]) {
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, e, r, b),
                                    k = q.color, g.push(q), markerColor = D(Ga), v && g.push({
                                        x: e,
                                        y: r,
                                        ctx: u,
                                        type: q.type,
    ...
    z.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = -Infinity, h = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)
                for (var n = a.dataSeriesIndexes[l], m = this.data[n], p = m.dataPoints, e = 0, d = 0; d < p.length; d++) f = p[d].getTime ? f = p[d].x.getTime() : f = p[d].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[d].z || (e = p[d].z, e > k && (k = e), e < h && (h = e));
            for (var r = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), l = 0; l < a.dataSeriesIndexes.length; l++)
                if (n = a.dataSeriesIndexes[l], m = this.data[n], p = m.dataPoints,
                    0 < p.length)
                    for (c.strokeStyle = "#4572A7 ", d = 0; d < p.length; d++)
                        if (f = p[d].getTime ? f = p[d].x.getTime() : f = p[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[d].y) {
                            ...
                            var e = p[d].z,
                                q = 2 * Math.max(Math.sqrt((k === h ? b / 2 : r + (b - r) / (k - h) * (e - h)) / Math.PI) << 0, 1),
                                e = m.getMarkerProperties(d, c);
                            e.size = q;
                            c.globalAlpha = m.fillOpacity;
                            N.drawMarker(f, g, c, e.type, e.size, e.color, e.borderColor, e.borderThickness);
                            c.globalAlpha =
                                1;
                            var s = m.dataPointIds[d];
                            ...
                            q = D(s);
                            v && N.drawMarker(f, g, this._eventManager.ghostCtx, e.type, e.size, q, q, e.borderThickness);
                            (p[d].indexLabel || m.indexLabel || p[d].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "bubble",
                                dataPoint: p[d],
                                dataSeries: m,
                                point: {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var m = 0, p = 0, d = 0; d < n.length; d++)
                        if (f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[d].y) {
                            ...
                            c.globalAlpha = 1;
                            Math.sqrt((m - f) * (m - f) + (p - g) * (p - g)) < Math.min(e.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (m = l.dataPointIds[d], this._eventManager.objectMap[m] = {
                                id: m,
                                objectType: "dataPoint",
                                dataSeriesIndex: h,
                                dataPointIndex: d,
                                x1: f,
                                y1: g
                            }, m = D(m), v && N.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, m, m, e.borderThickness), (n[d].indexLabel || l.indexLabel ||
                                n[d].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: n[d],
                                dataSeries: l,
                                point: {
    ...
    z.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
                d = this.plotArea,
                f = 0,
                g, k, h, l, n, m, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
                ...
                if (0 < s.length)
                    for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? m = s[f].x.getTime() : m = s[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            "candlestick" === q.type ? (c.moveTo(g - x, h), c.lineTo(g - x, Math.min(k, n)), c.stroke(), c.moveTo(g - x, Math.max(k, n)), c.lineTo(g - x, l), c.stroke(), M(c,
                                ...
                                h), b.lineTo(g - x, l), b.stroke(), b.beginPath(), b.moveTo(g, k), b.lineTo(w, k), b.stroke(), b.beginPath(), b.moveTo(g, n), b.lineTo(y, n), b.stroke()));
    ...
    z.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            h = this.dataPointWidth ?
                this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && f > g && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, g));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && g < f) && (g = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, f));
            h < f && (h = f);
            h > g && (h = g);
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                var n = a.dataSeriesIndexes[l],
                    ...
                    p = m.dataPoints;
                if (0 < p.length)
                    for (var e = 5 < h && m.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)
                        if (p[f].getTime ? k = p[f].x.getTime() : k = p[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                            b =
                                a.axisX.convertValueToPixel(k);
                            d = a.axisY.convertValueToPixel(p[f].y[0]);
                            g = a.axisY.convertValueToPixel(p[f].y[1]);
                            var r = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + l) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + l) * h << 0,
                                q = a.axisX.reversed ? r - h << 0 : r + h << 0,
                            ...
                            M(c, r, d, q, g, b, 0, b, e, e, !1, !1, m.fillOpacity);
                            b = D(s);
                            v && M(this._eventManager.ghostCtx, r, d, q, g, b, 0, null, !1, !1, !1, !1);
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                            ...
                            k = a.axisX.convertValueToPixel(h);
                            k = a.axisX.reversed ? k + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount + n) * l << 0 : k - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + n) * l << 0;
                            var q = a.axisX.reversed ? k - l << 0 : k + l << 0;
                            d > g && (b = d, d = g, g = b);
                            b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
                            M(c, d, k, g, q, b, 0, null, r, !1, !1, !1, p.fillOpacity);
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = D(b);
                            v && M(this._eventManager.ghostCtx, d, k, g, q,
                                b, 0, null, !1, !1, !1, !1);
    ...
    z.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.rect(k.x1, k.y1, k.width, k.height);
            b.clip();
            v && (d.beginPath(), d.rect(k.x1, k.y1, k.width, k.height), d.clip());
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var h = [],
                ...
                if (0 < m.length) {
                    ...
                    if (b.setLineDash) {
                        var A = F(n.nullDataLineDashType, n.lineThickness),
                            z = n.lineDashType,
                            C = F(z, n.lineThickness);
                        b.setLineDash(C)
                    }
                    for (var S = !0; e <
                        m.length; e++)
                        if (u = m[e].x.getTime ? m[e].x.getTime() : m[e].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))
                            if (null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                                ...
                                p || S ? (n.connectNullData && !p ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length -
                                    1].newLineDashArray = C, z = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, q), v && d.lineTo(r, q), h.push({
                                    x: r,
                                    y: s
                                    ...
                                    x: r,
                                    y: s
                                }), v && (d.beginPath(), d.moveTo(r, q))), S = p = !1) : (b.lineTo(r, q), h.push({
                                    x: r,
                                    y: s
                                ...
                                e < m.length - 1 && (x !== (m[e].lineColor || t) || z !== (m[e].lineDashType || n.lineDashType)) && (c(),
                                    x = m[e].lineColor || t, h[h.length - 1].newStrokeStyle = x, b.strokeStyle = x, b.setLineDash && (m[e].lineDashType ? (z = m[e].lineDashType, h[h.length - 1].newLineDashArray = F(z, n.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (z = n.lineDashType, h[h.length - 1].newLineDashArray = C, b.setLineDash(C))));
                                if (0 !== m[e].markerSize && (0 < m[e].markerSize || 0 < n.markerSize)) {
                                    var Q = n.getMarkerProperties(e, r, s, b);
                                    f.push(Q);
                                    var I = D(u);
                                    v && f.push({
                                        x: r,
                                    ...
                                    Q = n.getMarkerProperties(e, r, q, b);
                                    g = Q.color;
                                    f.push(Q);
                                    I = D(u);
                                    v && f.push({
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                var f = [],
                    ...
                    s = [];
                if (0 < n.length) {
                    var u = l._colorSet[m % l._colorSet.length],
                    ...
                    var t = "solid",
                        x;
                    if (b.setLineDash) {
                        var z = F(l.nullDataLineDashType, l.lineThickness),
                            t = l.lineDashType;
                        x = F(t, l.lineThickness)
                    }
                    for (e = !1; m < n.length; m++)
                        if (p = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !e)))
                            if (null !== n[m].y && n[m].y.length && "number" === typeof n[m].y[0] && "number" === typeof n[m].y[1]) {
                                ...
                                m < n.length - 1 && (y !== (n[m].lineColor || w) || t !== (n[m].lineDashType || l.lineDashType)) && (y = n[m].lineColor || w, q[q.length - 1].newStrokeStyle = y, b.setLineDash && (n[m].lineDashType ? (t = n[m].lineDashType, q[q.length - 1].newLineDashArray = F(t, l.lineThickness)) : (t = l.lineDashType, q[q.length - 1].newLineDashArray = x)));
                                if (0 !== n[m].markerSize && (0 < n[m].markerSize || 0 < l.markerSize)) {
                                    var C =
                                        l.getMarkerProperties(m, p, e, b),
                                        g = C.color;
                                    f.push(C);
                                    var S = D(A);
                                    v && f.push({
                                    ...
                                    C = l.getMarkerProperties(m, p, r, b);
                                    f.push(C);
                                    S = D(A);
                                    v && f.push({
                                        x: p,
                                ...
                                if (n[m].indexLabel || l.indexLabel || n[m].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "splineArea",
                                    dataPoint: n[m],
                                    dataSeries: l,
                                    indexKeyword: 0,
                                ...
                                e = !1
                            } else 0 < m && !e && (l.connectNullData ? b.setLineDash && (0 < q.length && (l.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = z, t = l.nullDataLineDashType) : (c(x, w), q = [], s = [])), e = !0;
                    c(x, w);
                    N.drawMarkers(f);
                    l.markerColor = g
                }
    ...
    var Ha = function (a, c, b, d, f, g, k, h, l) {
        if (!(0 > b)) {
            "undefined" === typeof h && (h = 1);
            if (!v) {
                var n = Number((k % (2 * Math.PI)).toFixed(8));
                Number((g % (2 * Math.PI)).toFixed(8)) === n && (k -= 1E-4)
            }
            a.save();
            a.globalAlpha = h;
            "pie" === f ? (a.beginPath(), a.moveTo(c.x, c.y), a.arc(c.x, c.y, b, g, k, !1), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === f && (a.beginPath(), a.arc(c.x,
                c.y, b, g, k, !1), 0 <= l && a.arc(c.x, c.y, l * b, k, g, !0), a.closePath(), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
            a.globalAlpha = 1;
            a.restore()
        }
    };
    z.prototype.renderPie = function (a) {
            ...
            if (n && m) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < m.length; f++) {
                    ...
                    var p = {
                        ...
                        q = null,
                        p = l.getPercentAndTotal(n, g);
                    if (n.indexLabelFormatter || g.indexLabelFormatter) q = {
                        chart: l.options,
                        dataSeries: n,
                        dataPoint: g,
                        total: p.total,
                    ...
                    p = g.indexLabelFormatter ? g.indexLabelFormatter(q) : g.indexLabel ? l.replaceKeywordsWithValue(g.indexLabel, g, n, f) : n.indexLabelFormatter ? n.indexLabelFormatter(q) : n.indexLabel ? l.replaceKeywordsWithValue(n.indexLabel, g, n, f) : g.label ? g.label : "";
                    ...
                    h.indexLabelLineColor = g.indexLabelLineColor ? g.indexLabelLineColor :
                        n.indexLabelLineColor ? n.indexLabelLineColor : g.color ? g.color : n._colorSet[f % n._colorSet.length];
                    h.indexLabelLineThickness = x(g.indexLabelLineThickness) ? n.indexLabelLineThickness : g.indexLabelLineThickness;
                    h.indexLabelLineDashType = g.indexLabelLineDashType ? g.indexLabelLineDashType : n.indexLabelLineDashType;
                    h.indexLabelFontColor = g.indexLabelFontColor ? g.indexLabelFontColor : n.indexLabelFontColor;
                    h.indexLabelFontStyle = g.indexLabelFontStyle ? g.indexLabelFontStyle : n.indexLabelFontStyle;
                    h.indexLabelFontWeight = g.indexLabelFontWeight ?
                        g.indexLabelFontWeight : n.indexLabelFontWeight;
                    h.indexLabelFontSize = g.indexLabelFontSize ? g.indexLabelFontSize : n.indexLabelFontSize;
                    h.indexLabelFontFamily = g.indexLabelFontFamily ? g.indexLabelFontFamily : n.indexLabelFontFamily;
                    h.indexLabelBackgroundColor = g.indexLabelBackgroundColor ? g.indexLabelBackgroundColor : n.indexLabelBackgroundColor ? n.indexLabelBackgroundColor : null;
                    h.indexLabelMaxWidth = g.indexLabelMaxWidth ? g.indexLabelMaxWidth : n.indexLabelMaxWidth ? n.indexLabelMaxWidth : 0.33 * e.width;
                    h.indexLabelWrap =
                        "undefined" !== typeof g.indexLabelWrap ? g.indexLabelWrap : n.indexLabelWrap;
                    h.startAngle = 0 === f ? n.startAngle ? n.startAngle / 180 * Math.PI : 0 : r[f - 1].endAngle;
                    h.startAngle = (h.startAngle + 2 * Math.PI) % (2 * Math.PI);
                    h.endAngle = h.startAngle + 2 * Math.PI / v * Math.abs(g.y);
                    g = (h.endAngle + h.startAngle) / 2;
                    g = (g + 2 * Math.PI) % (2 * Math.PI);
                    h.midAngle = g;
                    if (h.midAngle > Math.PI / 2 - w && h.midAngle < Math.PI / 2 + w) {
                        if (0 === a || r[c].midAngle > h.midAngle) c = f;
                        a++
                    } else if (h.midAngle > 3 * Math.PI / 2 - w && h.midAngle < 3 * Math.PI / 2 + w) {
                        if (0 === b || r[d].midAngle > h.midAngle) d =
                            f;
                        b++
                    }
                    h.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right";
                    h.indexLabelTextBlock = new W(l.plotArea.ctx, {
                ...
                k =
                    g = 0;
                p = !1;
                for (f = 0; f < m.length; f++) h = r[(c + f) % m.length], 1 < a && (h.midAngle > Math.PI / 2 - w && h.midAngle < Math.PI / 2 + w) && (g <= a / 2 && !p ? (h.hemisphere = "right", g++) : (h.hemisphere = "left", p = !0));
                p = !1;
                for (f = 0; f < m.length; f++) h = r[(d + f) % m.length], 1 < b && (h.midAngle > 3 * Math.PI / 2 - w && h.midAngle < 3 * Math.PI / 2 + w) && (k <= b / 2 && !p ? (h.hemisphere = "left", k++) : (h.hemisphere = "right", p = !0))
            }
        }
        ...
        function b(a) {
            ...
            for (b = 0; b <
                ...
                if (d > c) {
                    var f = 0.07 * A * Math.cos(r[b].midAngle),
                        ...
                        h = !1;
                    if (m[b].exploded) {
                        if (1E-9 < Math.abs(r[b].center.x - (t.x + f)) || 1E-9 < Math.abs(r[b].center.y - (t.y + g))) r[b].center.x = t.x + f * a, r[b].center.y = t.y + g * a, h = !0
                    } else if (0 < Math.abs(r[b].center.x - t.x) || 0 < Math.abs(r[b].center.y - t.y)) r[b].center.x = t.x + f * (1 - a), r[b].center.y = t.y + g * (1 - a), h = !0;
                    h && (f = {}, f.dataSeries = n, f.dataPoint = n.dataPoints[b], f.index = b, l.toolTip.highlightObjects([f]));
                    Ha(l.plotArea.ctx, r[b].center, r[b].radius, m[b].color ? m[b].color : n._colorSet[b % n._colorSet.length], n.type, c, d, n.fillOpacity, r[b].percentInnerRadius)
                }
            }
            a = l.plotArea.ctx;
            a.save();
            ...
            a.lineJoin = "round";
            for (b = b = 0; b < m.length; b++) c = r[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== n.indexLabelPlacement ? -(c.indexLabelTextBlock.width + p) : -c.indexLabelTextBlock.width / 2 : "inside" !==
                n.indexLabelPlacement ? p : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + A * Math.cos(c.midAngle), f = c.center.y + A * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(F(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(),
                    a.moveTo(d, f), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -p : p), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
            a.save()
        }
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < m.length) {
                var k = r[a];
                if (0 > b && k.indexLabelTextBlock.y < h ||
                    0 < b && k.indexLabelTextBlock.y > l) return 0;
                var p = 0,
                    n = 0,
                    n = p = p = 0;
                ...
                h = 0;
                h = "right" === k.hemisphere ? t.x + Math.sqrt(Math.pow(s,
                    2) - Math.pow(b - t.y, 2)) : t.x - Math.sqrt(Math.pow(s, 2) - Math.pow(b - t.y, 2));
                n = t.x + A * Math.cos(k.midAngle);
                p = t.y + A * Math.sin(k.midAngle);
                p = Math.sqrt(Math.pow(h - n, 2) + Math.pow(b - p, 2));
                n = Math.acos(A / s);
                p = Math.acos((s * s + A * A - p * p) / (2 * A * s));
                b = p < n ? b - k.indexLabelTextBlock.y : 0;
                h = null;
                for (l = 1; l < m.length; l++)
                    if (h = (a - l + r.length) % r.length, r[h].hemisphere !== r[a].hemisphere) {
                        h = null;
                        break
                    } else if (r[h].indexLabelText && r[h].hemisphere === r[a].hemisphere && h !== a && (0 > d(r[h], r[a]) || ("right" === r[a].hemisphere ? r[h].indexLabelTextBlock.y <=
                        r[a].indexLabelTextBlock.y : r[h].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y))) break;
                else h = null;
                n = h;
                p = f(a);
                l = h = 0;
                0 > b ? (l = "right" === k.hemisphere ? n : p, e = b, null !== l && (n = -b, b = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (r[l].indexLabelTextBlock.y + r[l].indexLabelTextBlock.height / 2), b - n < q && (h = -n, l = g(l, h, c + 1), +l.toFixed(y) > +h.toFixed(y) && (e = b > q ? -(b - q) : -(n - (l - h)))))) : 0 < b && (l = "right" === k.hemisphere ? p : n, e = b, null !== l && (n = b, b = r[l].indexLabelTextBlock.y - r[l].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y +
                    k.indexLabelTextBlock.height / 2), b - n < q && (h = n, l = g(l, h, c + 1), +l.toFixed(y) < +h.toFixed(y) && (e = b > q ? b - q : n - (h - l)))));
                e && (c = k.indexLabelTextBlock.y + e, b = 0, b = "right" === k.hemisphere ? t.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - t.y, 2)) : t.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - t.y, 2)), k.midAngle > Math.PI / 2 - w && k.midAngle < Math.PI / 2 + w ? (h = (a - 1 + r.length) % r.length, h = r[h], a = r[(a + 1 + r.length) % r.length], "left" === k.hemisphere && "right" === h.hemisphere && b > h.indexLabelTextBlock.x ? b = h.indexLabelTextBlock.x - 15 : "right" === k.hemisphere && ("left" ===
                    ...
                    t.y, k.indexLabelTextBlock.x - t.x))
            }
            return e
        }
        ...
        function k() {
            ...
            for (var b = a = 0, c = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                if (n.radius || !n.radius && "undefined" !== typeof n.innerRadius && null !== n.innerRadius && A - c <= C) h = !1;
                h && (A -= c);
                c = 0;
                if ("inside" !== n.indexLabelPlacement) {
                    ...
                    for (a = 0; a < m.length; a++) {
                        var k = r[a];
                        k.indexLabelTextBlock.x = t.x + s * Math.cos(k.midAngle);
                        k.indexLabelTextBlock.y = t.y + s * Math.sin(k.midAngle);
                        k.indexLabelAngle =
                            k.midAngle;
                        k.radius = A;
                    ...
                    for (var w, v, a = 0; a < m.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            var z = 0,
                                z = d(w, v) - q;
                            if (0 > z) {
                                for (var G = v = 0, D = 0; D < m.length; D++) D !== a && r[D].hemisphere === k.hemisphere && (r[D].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? v++ : G++);
                                v = z / (v + G || 1) * G;
                                var G = -1 * (z - v),
                                    B = D = 0;
                                "right" === k.hemisphere ? (D = g(a, v), G = -1 * (z - D), B = g(x, G), +B.toFixed(y) < +G.toFixed(y) && +D.toFixed(y) <= +v.toFixed(y) && g(a, -(G - B))) : (D = g(x, v), G = -1 * (z - D), B = g(a, G), +B.toFixed(y) < +G.toFixed(y) &&
                                    +D.toFixed(y) <= +v.toFixed(y) && g(x, -(G - B)))
                            }
                        }
                    }
                } else
                    for (a = 0; a < m.length; a++) k = r[a], s = "pie" === n.type ? 0.7 * A : 0.8 * A, x = t.x + s * Math.cos(k.midAngle), v = t.y + s * Math.sin(k.midAngle), k.indexLabelTextBlock.x = x, k.indexLabelTextBlock.y = v;
                for (a = 0; a < m.length; a++)
                    if (k = r[a], x = k.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width) x = x = 0, "right" === k.hemisphere ? (x = e.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + p), x *= -1) : x = e.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width - p), 0 < x && (!h && k.indexLabelText &&
                ...
                (function () {
                    for (var a = -1, b = -1, c = 0, e = !1, g = 0; g < m.length; g++)
                        if (e = !1, w = r[g], w.indexLabelText) {
                            ...
                            if (null !== h) {
                                ...
                                if (l = 0 > z) {
                                    ...
                                    var n = w.indexLabelTextBlock.y - w.indexLabelTextBlock.height / 2,
                                        q = w.indexLabelTextBlock.y + w.indexLabelTextBlock.height / 2,
                                        s = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height /
                                        2,
                                ...
                                l ? (0 > a && (a = g), h !== a && (b = h, c += -z), 0 === g % Math.max(m.length / 10, 3) && (e = !0)) : e = !0;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== v) {
                ...
                var A = "inside" !== n.indexLabelPlacement && a ? 0.75 * Math.min(e.width, e.height) / 2 : 0.92 * Math.min(e.width, e.height) /
                    2;
                n.radius && (A = Pa(n.radius, A));
                var C = "undefined" !== typeof n.innerRadius && null !== n.innerRadius ? Pa(n.innerRadius, A) : 0.7 * A;
                n.radius = A;
                "doughnut" === n.type && (n.innerRadius = C);
                var E = Math.min(C / A, (A - 1) / A);
                ...
                this._animator.animate(0,
                    ...
                    function (a) {
                        ...
                        for (b = 0; b < m.length; b++) {
                            ...
                            d > c && Ha(l.plotArea.ctx, r[b].center, r[b].radius, g, n.type, c, d, n.fillOpacity, r[b].percentInnerRadius);
                            if (f) break
                        }
                        h()
                    },
    ...
    W.prototype.measureText = function () {
        this._lineHeight =
            Ka(this.fontFamily, this.fontSize, this.fontWeight);
    ...
    W.prototype._getLineWithWidth = function (a, c, b) {
        ...
        b >
            c && 1 < k.length && (k = k.substr(0, k.length - 1), b = this.ctx.measureText(k).width);
        c = !0;
    ...
    oa.prototype.render = function () {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                ...
                h, l;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = c.width - 4 - k * ("center" === this.horizontalAlign ? 2 : 1)), g = 0.5 * c.height - this.margin - 2, f = 0) : "center" === this.verticalAlign &&
            ...
            var g = new W(this.ctx, {
                ...
                n = g.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (d = c.y1 + 2, l = "top") : "bottom" === this.verticalAlign && (d = c.y2 - 2 - n.height, l = "bottom"), "left" === this.horizontalAlign ? b = c.x1 + 2 : "center" === this.horizontalAlign ?
                ...
                2), b = a.x1 + (a.width / 2 - n.width / 2), l = "center", this.width = n.width, this.height = n.height), h = "center");
            g.x = b;
            g.y = d;
            g.angle = f;
            g.horizontalAlign = h;
    ...
    ya.prototype.render = function () {
        var a = this.dockInsidePlotArea ?
            ...
            g = 0,
            k = 0,
            h = this.markerMargin = this.chart.options.legend && !x(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var l = [],
            n = [];
        "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (this.orientation = "horizontal", b = this.verticalAlign, g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : c.width, k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * c.height) : "center" ===
            this.verticalAlign && (this.orientation = "vertical", b = this.horizontalAlign, g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * c.width, k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : c.height);
        for (var m = 0; m < this.dataSeries.length; m++) {
            var p = this.dataSeries[m];
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? ca.getDefaultLegendMarker(p.type) :
                    p.markerType,
                ...
                for (var v = 0; v < p.dataPoints.length; v++) {
                    var t = p.dataPoints[v],
                        e = t.legendMarkerType ? t.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : ca.getDefaultLegendMarker(p.type),
        ...
        if (0 < l.length) {
            ...
            for (m = 0; m < l.length; m++) {
                ...
                if (!(0 >= k || "undefined" === typeof k || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!p || p.width + Math.round(e.textBlock.width +
                                s + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p = {
                            items: [],
                            width: 0
                        ...
                        e.textBlock.measureText(), null !== this.itemWidth && (e.textBlock.width = this.itemWidth - (s + h + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < k - this.lineHeight ? (p = {
                            items: [],
                            width: 0
                        }, n.push(p)) : (p = n[t], t = (t + 1) % n.length), this.height += e.textBlock.height;
                    e.textBlock.x = p.width;
                    e.textBlock.y = 0;
                    p.width += Math.round(e.textBlock.width + s + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 *
                        0.1 * this.lineHeight : 0));
                    p.items.push(e);
                    this.width = Math.max(p.width, this.width);
                    q = e.textBlock.width + (s + h + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))
                }
            }
            this.itemWidth = q;
        ...
        this.items = l;
        for (m = 0; m < this.items.length; m++) e = l[m], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = {
            id: e.id,
        ...
        for (m = c = 0; m < n.length; m++) {
            ...
            for (t = v = 0; t < p.items.length; t++) {
                ...
                N.drawMarker(q + s / 2, u + this.lineHeight / 2, this.ctx, e.markerType, e.markerSize, e.markerColor, e.markerBorderColor, e.markerBorderThickness);
                e.textBlock.x = q + h + s;
    ...
    T(ca, L);
    ca.prototype.getDefaultAxisPlacement =
        function () {
            var a = this.type;
    ...
    ca.prototype.getDataPointAtX = function (a, c) {
        ...
        for (;;) {
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                d <= h ?
                    h = d : 0 < k ? l++ : n++;
                if (1E3 < l && 1E3 < n) break
            } else if (0 > m - f && m + f >= this.dataPoints.length) break; - 1 === k ? (f++, k = 1) : k = -1
        }
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "doughnut":
                            ...
                            q < e.radius && q > u && (q = Math.atan2(c - s.y, a - s.x), 0 > q && (q += 2 * Math.PI), q = Number(((180 * (q / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (e.startAngle / Math.PI) % 360 +
                                360) % 360).toFixed(12)), u = Number(((180 * (e.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < e.endAngle && (u = 360), s >= u && 0 !== r.y && (u += 360, q < s && (q += 360)), q > s && q < u && (d.push({
                                dataPoint: r,
                                dataPointIndex: g,
                                dataSeries: this,
                                distance: 0
                    ...
                    if (h || 1E3 < n && 1E3 < m) break
                }
            } else if (0 > p - f &&
                p + f >= this.dataPoints.length) break; - 1 === k ? (f++, k = 1) : k = -1
        }
        a = null;
    ...
    A.prototype.createExtraLabelsForLog = function (a) {
        ...
        if (!(5 < a)) {
            ...
            if (Math.log(this.range) / Math.log(c / this.viewportMinimum) < this.noTicks - 1) {
                for (var b = A.getNiceNumber((c - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length),
    ...
    A.prototype.createLabels = function () {
        ...
        if ("axisX" === this.type && 0 < this.dataSeries.length && "dateTime" === this.dataSeries[0].xValueType && !this.logarithmic)
            for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval),
                f = Ia(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ia(b, h, this.intervalType)) a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.options,
                value: b,
            ...
            if (this.labels) {
                a = Math.ceil(h);
                for (var h = Math.ceil(this.intervalStartPosition), p = !1, b = h; b < this.viewportMaximum; b += a)
        ...
        if ("bottom" === this._position || "top" === this._position) l = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) /
        ...
        else if ("left" === this._position || "right" === this._position) l =
            this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * C[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (g = "undefined" ===
                typeof this.options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth), k = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)
            if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -=
                ...
                if (g = 0.9 * l >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = 0; b < this._labels.length; b++) {
                        ...
                        for (var q, s = a.text.split(" "),
                                d = 0; d < s.length; d++) e = s[d], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, e = this.ctx.measureText(e), e.width > p && (q = b, p = e.width)
                    }
                    b = 0;
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        if (a = this._labels[b].textBlock, r = a.measureText(), b < this._labels.length - 1 && (e = b + 1, c = this._labels[e].textBlock, c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math, f), Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), Math.sin(Math.PI /
                                180 * Math.abs(this.labelAngle)), d = g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (k - a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), x(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : Math.min((d - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d), s = (m - (n + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !x(this.options.labelWrap)) this.labelWrap ? x(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, p), s), this.sessionVariables.labelWrap = this.labelWrap, r.width + c.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > g ? -25 : this.sessionVariables.labelAngle) : x(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap =
                                ...
                                if (x(this.options.labelWrap))
                                    if (!x(this.options.labelMaxWidth)) this.options.labelMaxWidth <
                                        g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = k);
                                    else if (!x(c))
                                    if (d = r.width + c.width >> 0, e = this.labelFontSize, p < g) d - 2 * g > h && (h = d - 2 * g, d >= 2 * g && d < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g, x(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e), a.measureText()), this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ?
                                        ...
                                        e : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : d >= 3.2 * g && d < 3.6 * g ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = s, this.sessionVariables.labelFontSize = this.labelFontSize) : d > 3.6 * g && d < 5 * g ? (x(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e), a.measureText()), this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s) : d > 5 * g && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = g, this.sessionVariables.labelFontSize = e, this.sessionVariables.labelMaxHeight = k, this.sessionVariables.labelAngle = this.labelAngle));
                                    else if (q === b && (0 === q && p + this._labels[q + 1].textBlock.measureText().width - 2 * g > h || q === this._labels.length - 1 && p + this._labels[q - 1].textBlock.measureText().width - 2 * g > h || 0 < q && q < this._labels.length - 1 && p + this._labels[q + 1].textBlock.measureText().width - 2 * g > h &&
                                    ...
                                    for (this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, d = 0; d < this._labels.length; d++) a = this._labels[d].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, p), s), r = a.measureText(), d < this._labels.length - 1 && (e = d + 1, c = this._labels[e].textBlock, c.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, p), s), c = c.measureText(), r.width + c.width >> 0 > 2 * g && (this.sessionVariables.labelAngle = -25))
                            } else(this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : Math.min((d - g * Math.cos(Math.PI /
                        ...
                        this.options.labelMaxWidth : s) : (x(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : s, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = k);
                    for (d = 0; d < this._labels.length; d++) a = this._labels[d].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth, a.fontSize = this.sessionVariables.labelFontSize, a.angle = this.labelAngle = this.sessionVariables.labelAngle, a.wrap = this.labelWrap = this.sessionVariables.labelWrap,
            ...
            if (g = x(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, k = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                ...
                for (b = 0; b < this._labels.length; b++)(a = this._labels[b].textBlock, r = a.measureText(), b < this._labels.length - 1 && (e = b + 1, c = this._labels[e].textBlock, c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math, f), d = g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (k - a.fontSize / 2) * Math.cos(Math.PI /
                    ...
                    this.labelWrap, this.sessionVariables.labelMaxWidth = g) : (this.sessionVariables.labelMaxHeight = k, x(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap);
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            } else k = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, u = "undefined" === typeof g.options.labelWrap || g.labelWrap ? "bottom" === this._position ||
    ...
    A.setLayoutAndRender = function (a, c, b, d, f, g) {
        var k, h, l, n, m = a[0] ? a[0].chart : c[0].chart,
            p = m.ctx;
        if (a && 0 < a.length)
        ...
        if ("normal" === f) {
            ...
            for (; 4 > r;) {
                var M = 0,
                    ...
                    T = 0;
                if (b && 0 < b.length)
                    for (v = [], e = U = 0; e < b.length; e++) v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), U += v[e], B += b[e] ? b[e].margin : 0;
                else v.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                L.push(v);
                if (d && 0 < d.length)
                    for (t = [], e = T = 0; e < d.length; e++) t.push(Math.ceil(d[e] ?
                        d[e].createLabelsAndCalculateWidth() : 0)), T += t[e], R += d[e] ? d[e].margin : 0;
                else t.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                K.push(t);
                k = Math.round(g.x1 + U + B);
                l = Math.round(g.x2 - T - R > m.width - 10 ? m.width - 10 : g.x2 - T - R);
                if (a && 0 < a.length)
                    for (u = [], e = Y = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(l - k), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width),
                ...
                H.push(u);
                if (c && 0 < c.length)
                    for (w = [], e = V = 0; e < c.length; e++) c[e] && (c[e].lineCoordinates = {}), c[e].lineCoordinates.width = Math.abs(l - k), c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width), w.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() :
                        0)), V += w[e], Z += c[e] ? c[e].margin : 0;
                else w.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                J.push(w);
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates.x1 = k, a[e].lineCoordinates.x2 = Math.round(g.x2 - T - R > m.width - 10 ? m.width - 10 : g.x2 - T - R), a[e]._labels && 1 < a[e]._labels.length && (h = n = 0, n = a[e]._labels[1], h = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1], q = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) +
                        ...
                        f + M), n = Math.round(g.y2), a[e].lineCoordinates.x2 = l, a[e].lineCoordinates.width = l - k, a[e].lineCoordinates.y1 = h, a[e].lineCoordinates.y2 = h, a[e].bounds = {
                        x1: k,
                        y1: h,
                        x2: l,
                        y2: n - (Y + f - u[e] - M),
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e].lineCoordinates.x1 = Math.round(g.x1 + U + B), c[e].lineCoordinates.x2 = Math.round(g.x2 - T - R > m.width - 10 ? m.width - 10 : g.x2 - T - R), c[e].lineCoordinates.width = Math.abs(l - k), c[e]._labels && 1 < c[e]._labels.length && (n = c[e]._labels[1], h = "dateTime" === c[e].chart.plotInfo.axisXValueType ?
                        ...
                        n = Math.round(g.y2 + c[e].margin), c[e].lineCoordinates.y1 = h + V + Z - P, c[e].lineCoordinates.y2 = h, c[e].bounds = {
                            x1: k,
                            y1: h + (V + Z - w[e] - P),
                            x2: l,
                            y2: n,
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) B = 10, b[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), B = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, h = Math.round(g.y1 + V + Z < Math.max(B, 10) ? Math.max(B, 10) : g.y1 + V + Z), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1),
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2),
                        l = Math.round(k), B = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(g.y1 + V + Z < Math.max(B, 10) ? Math.max(B, 10) : g.y1 + V + Z), B = 0 < a.length ? 0 : d[e]._labels[0].textBlock.height / 2, n = Math.round(g.y2 - (Y + f + B)), d[e].lineCoordinates = {
                            x1: k + O,
                            y1: h,
                            x2: k + O,
                            y2: n,
                ...
                if (0 < r) {
                    if (a && 0 < a.length)
                        for (e = 0; e < a.length; e++) D = H[r - 1][e] === H[r][e] ? !0 : !1;
                    else D = !0;
                    if (c && 0 < c.length)
                        for (e = 0; e < c.length; e++) E = J[r - 1][e] === J[r][e] ? !0 : !1;
                    else E = !0;
                    if (b && 0 < b.length)
                        for (e = 0; e < b.length; e++) F = L[r - 1][e] === L[r][e] ? !0 : !1;
                    else F = !0;
                    if (d && 0 < d.length)
                        for (e = 0; e < d.length; e++) I = K[r - 1][e] === K[r][e] ? !0 : !1;
                    else I = !0
                }
                if (D && E && F && I) break;
                r++
            ...
            for (; 4 > r;) {
                V = Y = U = O = R = B = Z = f = N = K = P = M = 0;
                if (a && 0 < a.length)
                    for (C = [], e = Y = 0; e < a.length; e++) C.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() :
                        0)), Y += C[e], f += a[e] ? a[e].margin : 0;
                else C.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                J.push(C);
                if (c && 0 < c.length)
                    for (q = [], e = V = 0; e < c.length; e++) q.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)), V += q[e], Z += c[e] ? c[e].margin : 0;
                else q.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                L.push(q);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) b[e].lineCoordinates = {}, k = Math.round(g.x1 + Y + f), l = Math.round(g.x2 - V - Z > m.width - 10 ? m.width - 10 : g.x2 - V - Z), b[e].labelAutoFit && !x(u) && (0 < !a.length &&
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e].lineCoordinates = {}, k = Math.round(g.x1 + Y + f), l = Math.round(g.x2 - V -
                ...
                s.push(z);
                if (d && 0 < d.length)
                    for (A = [], e = U = 0; e < d.length; e++) A.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateHeight() : 0)), U += A[e], R += d[e].margin;
                else A.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                H.push(A);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) 0 < b[e]._labels.length && (n = b[e]._labels[0], h = b[e]._labels[b[e]._labels.length - 1], u = n.textBlock.width *
                        Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) + (n.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(n.textBlock.angle)), w = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && 0 < d[e]._labels.length && (n = d[e]._labels[0], h = d[e]._labels[d[e]._labels.length - 1], v = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) +
                        (n.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(n.textBlock.angle)), t = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                if (m.panEnabled)
                    for (e = 0; e < b.length; e++) z[e] = m.sessionVariables.axisY.height;
                else
                    for (e = 0; e < b.length; e++) m.sessionVariables.axisY.height = z[e];
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--) h = Math.round(g.y2), n = Math.round(g.y2 > b[e].chart.height - 10 ?
                        b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = h - (z[e] + b[e].margin + M), b[e].lineCoordinates.y2 = h - (z[e] + b[e].margin + M), b[e].bounds = {
                        x1: k,
                        y1: h - (z[e] + M + b[e].margin),
                        x2: l,
                        y2: n - (M + b[e].margin),
                        width: l - k,
                        height: z[e]
                ...
                if (d && 0 < d.length)
                    for (e = d.length - 1; 0 <= e; e--) d[e] && (h = Math.round(g.y1), n = Math.round(g.y1 + (A[e] + d[e].margin + P)),
                        d[e].lineCoordinates.y1 = n, d[e].lineCoordinates.y2 = n, d[e].bounds = {
                            x1: k,
                            y1: h + (d[e].margin + P),
                            x2: l,
                            y2: n,
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        k = Math.round(g.x1 + f);
                        h = d && 0 < d.length ? Math.round(d[0] ? d[0].lineCoordinates.y2 : g.y1 < Math.max(B,
                            10) ? Math.max(B, 10) : g.y1) : g.y1 < Math.max(B, 10) ? Math.max(B, 10) : g.y1;
                        l = Math.round(g.x1 + Y + f);
                        ...
                        if (b && 0 < b.length)
                            for (B = 0; B < b.length; B++) b[B] && b[B].labelAutoFit && (l = 0 > b[B].labelAngle ? Math.max(l, u) : 0 === b[B].labelAngle ? Math.max(l, u / 2) : l, k = 0 > b[B].labelAngle || 0 === b[B].labelAngle ? l - Y : k);
                        if (d && 0 < d.length)
                            for (B = 0; B < d.length; B++) d[B] && d[B].labelAutoFit &&
                                (l = d[B].lineCoordinates.x1, k = l - Y);
                        a[e].lineCoordinates = {
                            x1: l - K,
                            y1: h,
                            x2: l - K,
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        B = c[e]._labels && 0 < c[e]._labels.length ? c[e]._labels[0].textBlock.fontSize /
                            2 : 0;
                        k = Math.round(g.x1 - f);
                        h = d && 0 < d.length ? Math.round(d[0] ? d[0].lineCoordinates.y2 : g.y1 < Math.max(B, 10) ? Math.max(B, 10) : g.y1) : g.y1 < Math.max(B, 10) ? Math.max(B, 10) : g.y1;
                        l = Math.round(g.x2 - V - Z);
                        n = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - O > m.height - Math.max(B, 10) ? m.height - Math.max(B, 10) : g.y2 - O) : g.y2 > m.height - Math.max(B, 10) ? m.height - Math.max(B, 10) : g.y2;
                        if (b && 0 < b.length)
                            for (B = 0; B < b.length; B++) b[B] && b[B].labelAutoFit && (l = 0 > b[e].labelAngle ? Math.max(l, u) : 0 === b[e].labelAngle ? Math.max(l, u / 2) : l, k =
                                0 > b[B].labelAngle || 0 === b[B].labelAngle ? l - V : k);
                        if (d && 0 < d.length)
                            for (B = 0; B < d.length; B++) d[B] && d[B].labelAutoFit && (l = d[B].lineCoordinates.x2, k = l - V);
                        c[e].lineCoordinates = {
                            x1: l + N,
                            y1: h,
                            x2: l + N,
                ...
                if (0 < r) {
                    if (a && 0 < a.length)
                        for (e = 0; e < a.length; e++) D = J[r - 1][e] === J[r][e] ? !0 : !1;
                    else D = !0;
                    if (c && 0 < c.length)
                        for (e = 0; e < c.length; e++) E = L[r - 1][e] === L[r][e] ? !0 : !1;
                    else E = !0;
                    if (b && 0 < b.length)
                        for (e = 0; e < b.length; e++) F = s[r - 1][e] === s[r][e] ? !0 : !1;
                    else F = !0;
                    if (d && 0 < d.length)
                        for (e = 0; e < d.length; e++) I = H[r - 1][e] === H[r][e] ? !0 : !1;
                    else I = !0
                }
                if (D && E &&
                    F && I) break;
    ...
    A.prototype.renderLabelsTicksAndTitle = function () {
            ...
            if ("bottom" ===
                ...
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], d = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, k = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        ...
                        m.position > this.viewportMaximum || !(l === this._labels.length - 1 || g < Math.log(k / m.position) * h / d) || (c.push(m), k = m.position, g = m.textBlock.width * Math.abs(Math.cos(Math.PI /
                            180 * this.labelAngle)) + m.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (l = 0; l < this._labels.length; l++) m = this._labels[l], m.position < this.viewportMinimum || (m = m.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + m.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += m);
                    c > this.lineCoordinates.width * d && this.labelAutoFit && (a = !0)
                }
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], n, k = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        m = this._labels[l];
                        if (m.position < this.viewportMinimum) break;
                        m.position > this.viewportMaximum || !(l === this._labels.length - 1 || n < Math.log(k / m.position) * h) || (c.push(m), k = m.position, n = m.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + m.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (l = 0; l < this._labels.length; l++) m = this._labels[l], m.position <
        ...
        if ("bottom" === this._position) {
            for (var m, l = 0; l < this._labels.length; l++) m = this._labels[l], m.position < this.viewportMinimum || m.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(m.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
            ...
            for (l = 0; l < this._labels.length; l++) m = this._labels[l], m.position < this.viewportMinimum || m.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(m.position),
            ...
            for (l = 0; l < this._labels.length; l++) m = this._labels[l], m.position < this.viewportMinimum || m.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(m.position), a && 0 !== f++ % 2 && this.labelAutoFit ||
    ...
    A.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var c = this, b, d = 0, f = 0, g = !1, k = !1, h = [], l = [],
                    k = !1, d = 0; d < this.stripLines.length; d++) {
                var n = this.stripLines[d];
                n._thicknessType === a && ("pixel" === a && (n.value < this.viewportMinimum || n.value > this.viewportMaximum || isNaN(this.range)) || h.push(n))
            }
            for (d = 0; d < this._stripLineLabels.length; d++)
                if (n = this.stripLines[d], b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
            ...
            if (!k) {
                ...
                this.ctx.clip();
                for (d = 0; d < h.length; d++) n = h[d], n.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                    this.ctx.save();
                    this.ctx.beginPath();
                    this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                    this.ctx.clip();
                    for (f = 0; f < h.length; f++) n = h[f], n.showOnTop && n.render();
                    this.ctx.restore()
                }, n)) : n.render();
    ...
    A.prototype.calculateAxisParameters = function () {
        if (this.logarithmic) this.calculateLogarithamicAxisParameters();
            ...
            "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, f = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 0 === f - d && (b = "undefined" === typeof this.options.interval ?
                ...
                d = 0), 0 === d && 0 === f ? (f += 9, d = 0) : 0 === f - d ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += b, d -= b) : d > f ? (b = Math.min(Math.abs(0.01 * Math.abs(f - d)), 5), 0 <= f ? d = f - b : f = d + b) : (b = Math.min(Math.abs(0.01 * Math.abs(f - d)), 0.05), 0 !== f && (f += b), 0 !== d && (d -= b)), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - d ? 0.5 * Math.abs(f - d) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < d && (d = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > f && (f = 0));
            b = (isNaN(this.viewportMaximum) ||
                null === this.viewportMaximum ? f : this.viewportMaximum) - (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? d : this.viewportMinimum);
            if ("axisX" === this.type && 0 < this.dataSeries.length && "dateTime" === this.dataSeries[0].xValueType) {
                this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval =
                    ...
                    a ? (this.interval = 2, this.intervalType = "week") : b / (3 * C.weekDuration) <= a ? (this.interval = 3, this.intervalType = "week") : b / (1 * C.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * C.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : b / (3 * C.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * C.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * C.yearDuration) <= a ? 1 : b / (2 * C.yearDuration) <= a ? 2 : b / (4 * C.yearDuration) <= a ? 4 : Math.floor(A.getNiceNumber(b /
                        (a - 1), !0) / C.yearDuration), this.intervalType = "year"));
                if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = d - g / 2;
                ...
                this.interval = this.options && 0 < this.options.interval ? this.options.interval : A.getNiceNumber(b /
                    (a - 1), !0);
                if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = "axisX" === this.type ? d - g / 2 : Math.floor(d / this.interval) * this.interval;
                ...
                0 === this.viewportMaximum && 0 === this.viewportMinimum && (0 === this.options.viewportMinimum ? this.viewportMaximum += 10 : 0 === this.options.viewportMaximum && (this.viewportMinimum -= 10), this.options && "undefined" ===
                    typeof this.options.interval && (this.interval = A.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)))
            }
            if (null === this.minimum || null === this.maximum)
                if ("axisX" === this.type ? (d = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === f - d && (b = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, f += b, d -= b), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - d ? 0.5 * Math.abs(f - d) : 1) : "axisY" === this.type && (d = null !== this.minimum ?
                        ...
                        this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < d && (d = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > f && (f = 0)), "axisX" === this.type && 0 < this.dataSeries.length && "dateTime" === this.dataSeries[0].xValueType) {
                    if (null === this.minimum || isNaN(this.minimum)) this.minimum = d - g / 2;
                    if (null === this.maximum || isNaN(this.maximum)) this.maximum = f + g / 2
                } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? d - g / 2 : Math.floor(d / this.interval) * this.interval, this.minimum =
            ...
            this.intervalStartPosition = "axisX" === this.type && 0 < this.dataSeries.length && "dateTime" === this.dataSeries[0].xValueType ? this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval) : Math.floor((this.viewportMinimum + 0.2 * this.interval) /
    ...
    A.prototype.calculateLogarithamicAxisParameters = function () {
        ...
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
        if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum;
        "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, f = null !== this.viewportMaximum ? this.viewportMaximum :
            ...
            f / d * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 1 < d && (d = 1), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 1 > f && (f = 1));
        ...
        linearRange = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? f : this.viewportMaximum) - (isNaN(this.viewportMinimum) ||
            null === this.viewportMinimum ? d : this.viewportMinimum);
        this.intervalType = "number";
        k = Math.pow(this.logarithmBase, A.getNiceNumber(Math.abs(Math.log(k) / c), !1));
        this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = A.getNiceExponent(Math.log(k) / c / (a - 1), !0), b = A.getNiceNumber(linearRange / (a - 1), !0));
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = "axisX" === this.type ? d / Math.sqrt(g) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(d) /
            c / this.interval));
        ...
        1 === this.viewportMaximum && 1 === this.viewportMinimum && (1 === this.options.viewportMinimum ? this.viewportMaximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this.options.viewportMaximum && (this.viewportMinimum /= this.logarithmBase - 1 / this.logarithmBase), this.options && "undefined" === typeof this.options.interval &&
            (this.interval = A.getNiceExponent(Math.ceil(Math.log(k) / c) / (a - 1)), b = A.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        ...
        d =
            Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (c * this.interval) + 0.2) * this.interval);
        this.range = this.viewportMaximum / this.viewportMinimum;
        this.noTicks = a;
    ...
    A.prototype.getLabelStartPoint = function () {
        var a = C[this.intervalType + "Duration"] * this.interval,
            a = new Date(Math.floor(this.viewportMinimum / a) * a);
        if ("millisecond" !== this.intervalType)
            if ("second" === this.intervalType) 0 <
                a.getMilliseconds() && (a.setSeconds(a.getSeconds() + 1), a.setMilliseconds(0));
    ...
    pa.prototype.createUserOptions = function (a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder) {
            ...
            this.options._isPlaceholder ||
                (sa(this.parent.stripLines), c = this.parent.options.stripLines.indexOf(this.options));
            this.options = "undefined" === typeof a ? {} : a;
    ...
    pa.prototype.render = function () {
        ...
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) f = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, k = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = {
                x1: f - c / 2,
                y1: k,
                x2: g + c / 2,
                y2: h
            };
            else if ("left" === this.parent._position || "right" === this.parent._position) k = h = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1,
                g = this.chart.plotArea.x2, this.bounds = {
                    x1: f,
                    y1: k - c / 2,
                    x2: g,
                    y2: h + c / 2
    ...
    U.prototype._updateToolTip = function (a, c, b) {
        b = "undefined" === typeof b ? !0 : b;
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var h = 0; h < this.chart.axisX.length; h++) {
                            for (var k = this.chart.axisX[h].convertPixelToValue({
                                    y: c
                                }), l = null, d = 0; d < this.chart.axisX[h].dataSeries.length; d++)(l = this.chart.axisX[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[h].dataSeries[d], null !==
                                l.dataPoint.y && f.push(l));
                            l = null
                        }
                    if (this.chart.axisX2)
                        for (h = 0; h < this.chart.axisX2.length; h++) {
                            ...
                            l = null;
                            for (d = 0; d < this.chart.axisX2[h].dataSeries.length; d++)(l = this.chart.axisX2[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[h].dataSeries[d], null !== l.dataPoint.y && f.push(l));
                            l = null
                        }
                } else {
                    f = [];
                    if (this.chart.axisX)
                        for (h = 0; h < this.chart.axisX.length; h++)
                            for (k = this.chart.axisX[h].convertPixelToValue({
                                ...
                                this.chart.axisX[h].dataSeries.length; d++)(l = this.chart.axisX[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[h].dataSeries[d], null !== l.dataPoint.y && f.push(l));
                    if (this.chart.axisX2)
                        for (h = 0; h < this.chart.axisX2.length; h++)
                            for (k = this.chart.axisX2[h].convertPixelToValue({
                                    x: a
                                }), l = null, d = 0; d < this.chart.axisX2[h].dataSeries.length; d++)(l = this.chart.axisX2[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[h].dataSeries[d], null !== l.dataPoint.y &&
                                f.push(l))
                }
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    if (0 <= this.currentDataPointIndex) d = f.dataPoints[this.currentDataPointIndex], l.dataSeries = f, l.dataPoint = d, l.index = this.currentDataPointIndex, l.distance = Math.abs(d.x - k);
                        ...
                        if (!this.enabled || "line" !== f.type && "stepLine" !== f.type &&
                            "spline" !== f.type && "area" !== f.type && "stepArea" !== f.type && "splineArea" !== f.type && "stackedArea" !== f.type && "stackedArea100" !== f.type && "rangeArea" !== f.type && "rangeSplineArea" !== f.type && "candlestick" !== f.type && "ohlc" !== f.type) return;
                        k = f.axisX.convertPixelToValue({
                            x: a
                        });
                        l = f.getDataPointAtX(k, b);
                        l.dataSeries = f;
                    ...
                    if (!x(l.dataPoint.y))
                        if (l.dataSeries.axisY)
                            if (0 < l.dataPoint.y.length) {
                                for (d = b = 0; d < l.dataPoint.y.length; d++) l.dataPoint.y[d] < l.dataSeries.axisY.viewportMinimum ?
                                    b-- : l.dataPoint.y[d] > l.dataSeries.axisY.viewportMaximum && b++;
                                ...
                                b && l.dataPoint.y <= l.dataSeries.axisY.viewportMaximum + b && g.push(l)) : (0 <= l.dataSeries.type.indexOf("100") || "stackedColumn" === f.type || "stackedBar" === f.type || l.dataPoint.y >= l.dataSeries.axisY.viewportMinimum && l.dataPoint.y <= l.dataSeries.axisY.viewportMaximum) && g.push(l);
                    else g.push(l)
                }
            }
            if (0 < g.length && (this.highlightObjects(g), this.enabled))
                if (b = "", b = this.getToolTipInnerHTML({
                    ...
                    "pie" === g[0].dataSeries.type || "doughnut" === g[0].dataSeries.type || "funnel" === g[0].dataSeries.type || "bar" === g[0].dataSeries.type || "rangeBar" === g[0].dataSeries.type || "stackedBar" === g[0].dataSeries.type || "stackedBar100" === g[0].dataSeries.type ? a = a - 10 - this.container.clientWidth : (a = g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x) - this.container.clientWidth << 0, a -=
                        10);
                    ...
                    a += "px";
                    c = 1 !== g.length || this.shared || "line" !== g[0].dataSeries.type && "stepLine" !== g[0].dataSeries.type && "spline" !== g[0].dataSeries.type && "area" !== g[0].dataSeries.type && "stepArea" !== g[0].dataSeries.type && "splineArea" !== g[0].dataSeries.type ? "bar" === g[0].dataSeries.type ||
                        "rangeBar" === g[0].dataSeries.type || "stackedBar" === g[0].dataSeries.type || "stackedBar100" === g[0].dataSeries.type ? g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x) : c : g[0].dataSeries.axisY.convertValueToPixel(g[0].dataPoint.y);
                    c = -c + 10;
                    ...
                    !1 === g.highlightEnabled ||
                        !0 !== d.highlightEnabled && !0 !== g.highlightEnabled || ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "scatter" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type ? (g = d.getMarkerProperties(k, f.x1, f.y1, this.chart.overlaidCanvasCtx), g.size = Math.max(1.5 * g.size << 0, 10), g.borderColor = g.borderColor || "#FFFFFF", g.borderThickness = g.borderThickness || Math.ceil(0.1 * g.size), N.drawMarkers([g]),
                            ...
                            d.type || "bar" === d.type || "rangeBar" === d.type || "stackedBar" === d.type || "stackedBar100" === d.type || "rangeColumn" === d.type ? M(c, f.x1, f.y1, f.x2, f.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? Ha(c, f.center, f.radius, "white", d.type, f.startAngle, f.endAngle, 0.3, f.percentInnerRadius) : "candlestick" === d.type ? (c.globalAlpha = 1, c.strokeStyle = f.color, c.lineWidth = 2 * f.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(f.x3 - d, Math.min(f.y2, f.y3)), c.lineTo(f.x3 - d, Math.min(f.y1, f.y4)),
                                ...
                                f.y4), c.lineTo(f.x2, f.y4), c.stroke(), c.globalAlpha = 1))
                }
            }
            c.restore();
            c.globalAlpha = 1;
    ...
    U.prototype.getToolTipInnerHTML = function (a) {
        ...
        if (k && (this.content && "function" === typeof this.content || this.contentFormatter)) a = {
            ...
            for (var l = null, n = "", h = 0; h < a.length; h++)
                if (b = a[h].dataSeries, d = a[h].dataPoint, f = a[h].index, g = "", 0 === h && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? n += "undefined" !== typeof this.chart.axisX[0].labels[d.x] ? this.chart.axisX[0].labels[d.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (n += "undefined" !== typeof this.chart.axisX2[0].labels[d.x] ? this.chart.axisX2[0].labels[d.x] : "{x}"), n += "</br>", n = this.chart.replaceKeywordsWithValue(n,
                    ...
                    if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type) this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ?
                        b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}", l = b.axisXIndex;
                    else if ("bubble" === b.type) this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ?
                        b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
                    else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type) this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content &&
                        "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
                    ...
                    null === c && (c = "");
                    !0 === this.reversed ? (c = this.chart.replaceKeywordsWithValue(g, d, b, f) + c, h < a.length - 1 && (c = "</br>" + c)) : (c += this.chart.replaceKeywordsWithValue(g, d, b, f), h < a.length - 1 && (c += "</br>"))
                }
            null !== c && (c = n + c)
        } else {
            b = a[0].dataSeries;
            ...
            if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type) g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") +
                "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}";
            else if ("bubble" === b.type) g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
            else if ("pie" === b.type || "doughnut" === b.type || "funnel" === b.type) g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !==
                typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.name ? "{name}:</span>&nbsp;&nbsp;" : d.label ? "{label}:</span>&nbsp;&nbsp;" : "</span>") + "{y}";
            else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type) g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" :
                "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
            else if ("candlestick" === b.type || "ohlc" === b.type) g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
            null === c && (c = "");
            c += this.chart.replaceKeywordsWithValue(g,
                d, b, f)
        }
        return c
    };
    ...
    U.prototype.show = function (a, c, b) {
    ...
    z.prototype.getPercentAndTotal = function (a, c) {
        var b = null,
            d = null,
            f = null;
        if (0 <= a.type.indexOf("stacked")) d =
            0, b = c.x.getTime ? c.x.getTime() : c.x, b in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[b], f = isNaN(c.y) ? 0 : 0 === d ? 0 : 100 * (c.y / d));
    ...
    z.prototype.replaceKeywordsWithValue = function (a, c, b, d, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <=
            ...
            do {
                ...
                if (b.percentFormatString) l = b.percentFormatString;
                    ...
                    var l = "#,##0.",
                        n = Math.max(Math.ceil(Math.log(1 / Math.abs(k)) / Math.LN10), 2);
                    if (isNaN(n) || !isFinite(n)) n = 2;
                    for (var m = 0; m < n; m++) l += "#";
                    b.percentFormatString = l
                }
                a = a.replace("#percent", fa(k, l, g._cultureInfo));
                a = a.replace("#total", fa(h, b.yValueFormatString ? b.yValueFormatString : "#,##0.########", g._cultureInfo))
            } while (0 <=
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            if ("x" === a)
                ...
                } else return fa(h, c.xValueFormatString ? c.xValueFormatString :
    ...
    Ea.prototype.animate = function (a, c, b, d, f) {
        ...
        for (a = []; 0 < this.animations.length;)
            if (c = this.animations.shift(), b = (new Date).getTime(), d = 0, c.startTime <= b && (d = f(Math.min(b - c.startTime, c.duration), 0, 1, c.duration), d = Math.min(d, 1), isNaN(d) || !isFinite(d)) &&
        ...
        N = {
            drawMarker: function (a, c, b, d, f, g, k, h) {
                if (b) {
                    ...
                    b.lineWidth = h ? h : 0;
                    "circle" === d ? (b.moveTo(a, c), b.beginPath(), b.arc(a, c, f / 2, 0, 2 * Math.PI, !1), g && b.fill(), h && (k ? b.stroke() : (l = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = l))) : "square" === d ? (b.beginPath(), b.rect(a - f / 2, c - f / 2, f, f), g && b.fill(), h && (k ? b.stroke() : (l = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = l))) : "triangle" === d ? (b.beginPath(), b.moveTo(a - f / 2, c + f / 2), b.lineTo(a + f / 2, c + f / 2), b.lineTo(a, c - f / 2), b.closePath(),
                        g && b.fill(), h && (k ? b.stroke() : (l = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = l)), b.beginPath()) : "cross" === d && (b.strokeStyle = g, b.lineWidth = f / 4, b.beginPath(), b.moveTo(a - f / 2, c - f / 2), b.lineTo(a + f / 2, c + f / 2), b.stroke(), b.moveTo(a + f / 2, c - f / 2), b.lineTo(a - f / 2, c + f / 2), b.stroke())
                }
            },
